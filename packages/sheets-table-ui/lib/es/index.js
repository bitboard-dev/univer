...
var $n = (r, e, t) => e in r ? Nn(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var U = (r, e, t) => $n(r, typeof e != "symbol" ? e + "" : e, t);
import { Inject as E, IUniverInstanceService as pe, ICommandService as te, LocaleService as ne, Disposable as Le, ObjectMatrix as Ln, cellToRange as Zt, Rectangle as be, Injector as ke, IPermissionService as jt, IContextService as wt, CommandType as qt, IConfigService as Yt, ThemeService as kn, RxDisposable as Qt, VerticalAlign as rt, InterceptorEffectEnum as Pn, ErrorService as On, ColorKit as he, UniverInstanceType as Ye, DependentOn as Dn, Plugin as Bn, merge as Fn, registerDependencies as Vn, touchDependencies as Hn } from "@univerjs/core";
import { IRenderManagerService as Gt, SHEET_VIEWPORT_KEY as An, convertTransformToOffsetX as Un, convertTransformToOffsetY as Wn, Rect as Nt, Shape as Zn } from "@univerjs/engine-render";
...
import { Dropdown as Ee, clsx as D, borderClassName as H, CascaderList as Ir, Input as Rt, InputNumber as gt, DatePicker as yr, DateRangePicker as Rr, Select as Mr, Checkbox as Ot, scrollbarClassName as xr, ButtonGroup as Er, Button as _e, Segmented as Nr, ColorPicker as Ke } from "@univerjs/design";
...
let Ne = class extends Le {
  ...
  getTableFilterItems(e, t, n, i) {
    ...
    const s = a.getTableFilterRange(), { startRow: c, endRow: u, startColumn: h } = s, d = h + i, v = (N = this._univerInstanceService.getUnit(e)) == null ? void 0 : N.getSheetBySheetId(t);
    if (!v)
      return { data: [], itemsCountMap: /* @__PURE__ */ new Map(), allItemsCount: 0 };
  ...
  return /* @__PURE__ */ T("div", { children: [
    ...
    /* @__PURE__ */ T("div", { className: "univer-mt-3 univer-w-full", children: [
      ...
      d === j.DateRange && /* @__PURE__ */ l("div", { id: "univer-table-date-range-wrapper", children: /* @__PURE__ */ l(
        ...
        {
          className: "univer-w-full",
          value: [(N = (S = e.info.dateRange) == null ? void 0 : S[0]) != null ? N : /* @__PURE__ */ new Date(), ($ = (C = e.info.dateRange) == null ? void 0 : C[1]) != null ? $ : /* @__PURE__ */ new Date()],
          onValueChange: (g) => {
            u(g ? { dateRange: g } : {});
          }
        }
...
function di(r) {
  const { unitId: e, tableId: t, subUnitId: n, columnIndex: i, checkedItemSet: a, setCheckedItemSet: s, tableFilter: c } = r, u = M(ne), h = M(Ne), { data: d, itemsCountMap: v, allItemsCount: f } = h.getTableFilterItems(e, n, t, i), [w, S] = q(c === void 0 ? !0 : a.size === v.size), [N, C] = q(w ? f : ui(v)), $ = !w && a.size > 0, [I, B] = q(""), R = an(() => I ? d.filter((m) => String(m.title).toLowerCase().includes(I.toLowerCase())) : d, [I, d]), g = Dt(() => {
    ...
    if (w) {
      ...
      a.has(m) ? (a.delete(m), C(N - v.get(m))) : (a.add(m), C(N + v.get(m))), s(new Set(a));
  };
              ...
              /* @__PURE__ */ l("div", { className: "univer-flex univer-items-center univer-px-2 univer-py-1", children: /* @__PURE__ */ l(
                Ot,
                {
                  ...
                  children: /* @__PURE__ */ T("div", { className: "univer-flex univer-h-5 univer-flex-1 univer-items-center univer-text-sm", children: [
                    ...
                    /* @__PURE__ */ l("span", { className: "univer-ml univer-text-gray-400", children: `(${N}/${I ? R.length : f})` })
                  ] })
                }
              ) }),
              R.map((m) => /* @__PURE__ */ l(
...
function hi() {
  var de;
  const r = M(ne), e = vi(r), t = M(Ne), n = M(re), i = M(te), a = M(jt), s = M($e), c = s.getCurrentTableFilterInfo(), u = t.getTableFilterPanelInitProps(c.unitId, c.subUnitId, c.tableId, c.column), { unitId: h, subUnitId: d, tableId: v, tableFilter: f, currentFilterBy: w, columnIndex: S } = u, { data: N } = t.getTableFilterItems(h, d, v, S), C = t.getTableFilterCheckedItems(h, v, S), [$, I] = q(new Set(C)), [B, R] = q(w || me.Items), [g, x] = q(() => {
...
const Ci = () => {
  var fe, de;
  const [r, e] = q(""), [t, n] = q(""), i = M(cr), [a, s] = q({}), c = M(ke), u = M(it), h = Te(u.anchorPosition$), d = M(te), v = M(pe), f = M(cn), w = Te(f.unitPermissionInitStateChange$, !1), S = M(re), N = M(un), C = M(Ie), $ = Te(C.refreshTable$), I = M(ne), B = M(ut), R = Te(B.selectionChanged$, [{ range: Zt(0, 0), primary: null }]), [, g] = q(Math.random()), y = M(Yt).getConfig(wn), m = (fe = y == null ? void 0 : y.anchorHeight) != null ? fe : 24, O = (de = y == null ? void 0 : y.anchorBackgroundColor) != null ? de : "rgb(53,91,183)", L = (b, P) => {
    s((A) => ({
      ...A,
      [b]: P
    }));
  ...
  return w ? /* @__PURE__ */ l("div", { className: "univer-absolute univer-z-50 univer-h-0 univer-w-0", children: h.map((b) => {
    ...
    if (!P) return null;
    const A = N.getRangeThemeStyle(V, P.getTableStyleId()), Q = (p = (De = (Oe = A == null ? void 0 : A.getHeaderRowStyle()) == null ? void 0 : Oe.bg) == null ? void 0 : De.rgb) != null ? p : O, Qe = (K = (z = (_ = A == null ? void 0 : A.getHeaderRowStyle()) == null ? void 0 : _.cl) == null ? void 0 : z.rgb) != null ? K : "rgb(255, 255, 255)", Ge = P.getRange();
    if (!(R != null && R.length))
      return null;
    ...
    this.disposeWithMe(
      It(
        ...
        const u = a.reduce((d, v) => {
          const { startRow: f, startColumn: w } = v.range, S = s.with(lt), N = ar(this._univerInstanceService, this._renderManagerService);
          if (!N) return d;
          const { scene: C } = N, $ = C.getViewport(An.VIEW_MAIN);
          if (!$) return d;
...
class Ut {
  ...
  static drawIconByPath(e, t, n, i) {
    e.save(), e.strokeStyle = n, e.fillStyle = i, Nt.drawWith(e, {
      radius: 2,
      width: Me,
      height: Me,
      fill: i
...
var Ei = Object.getOwnPropertyDescriptor, Ni = (r, e, t, n) => {
  ...
  _renderButtons(e) {
    ...
    if (u) {
      for (const { range: h, states: d, tableId: v } of t) {
        ...
        for (let N = w; N <= S; N++) {
          const C = `sheets-table-filter-button-${f}-${N}`, $ = sr(f, N, c, i), I = u.getCellStyle(f, N), B = (I == null ? void 0 : I.vt) || rt.BOTTOM, { startX: R, startY: g, endX: x, endY: y } = $, m = x - R, O = y - g;
          if (O <= qe || m <= qe)
            continue;
          const L = d[N - w], Y = x - oe - qe, V = Li(g, y, O, B), G = {
            left: Y,
            top: V,
            height: oe,
            width: oe,
            ...
            cellHeight: O,
            cellWidth: m,
            filterParams: { unitId: n, subUnitId: a, row: f, col: N, buttonState: L, tableId: v }
...
const ki = (r) => {
  ...
  return /* @__PURE__ */ T(yt, { children: [
    /* @__PURE__ */ l(
      Hr,
      {
        ...
        initialValue: Ht(n),
        onChange: (S, N) => {
          const C = Ht(n), $ = Vr(N).range, I = ct(w, { unitId: e, subUnitId: t });
          if (!I)
            return;
  ...
  return /* @__PURE__ */ T("div", { children: [
    ...
    /* @__PURE__ */ l("div", { className: "univer-flex univer-gap-2", children: N.map((p) => {
