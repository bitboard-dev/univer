...
const Th = "univer-overflow-hidden univer-font-[500] univer-truncate univer-h-[24px] univer-mb-2 univer-leading-[24px] univer-ellipsis univer-cursor-pointer univer-pr-1 ", Bh = "univer-text-base univer-font-semibold", Mh = "univer-text-sm univer-font-semibold", _h = "univer-text-sm", Dh = Be((n, e) => {
