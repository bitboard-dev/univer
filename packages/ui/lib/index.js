...
var i2 = (e, t, n) => t in e ? r2(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
var F = (e, t, n) => i2(e, typeof t != "symbol" ? t + "" : t, n);
var L3 = (e, t, n) => t.has(e) ? o2("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n);
import { Disposable as v1, createIdentifier as g1, CommandType as r3, toDisposable as h1, IUniverInstanceService as A1, DocumentFlavor as Ot, LocaleService as x1, ColorKit as E3, NAMED_STYLE_MAP as s2, IConfigService as le, NamedStyleType as k1, Workbook as l2, UniverInstanceType as w3, DocumentDataModel as u9, SlideDataModel as a2, remove as Et, FOCUSING_UNIVER_EDITOR as Ze, IContextService as be, Inject as m1, Injector as V1, merge as Ae, convertObservableToBehaviorSubject as c2, isRealNum as u2, ErrorService as d2, RedoCommand as z3, UndoCommand as W3, IUndoRedoService as h2, EDITOR_ACTIVATED as d9, FOCUSING_FX_BAR_EDITOR as h9, ICommandService as ae, Optional as f9, dedupeBy as f2, generateRandomId as ge, throttle as C2, ThemeService as Y3, LifecycleStages as _3, LifecycleUnreachableError as v2, isInternalEditorID as g2, LifecycleService as C9, ILogService as p2, DependentOn as v9, Plugin as g9, registerDependencies as p9, mergeOverrideWithDependencies as m9, ILocalStorageService as b9, touchDependencies as ne, BaselineOffset as y3, getBorderStyleType as Z1, BorderStyleTypes as m2, Tools as L9 } from "@univerjs/core";
import { BehaviorSubject as X1, distinctUntilChanged as w9, Observable as pe, switchMap as b2, isObservable as Be, fromEvent as L2, Subject as N1, of as Le, combineLatest as ce, merge as w2, first as _2, throttleTime as M3, animationFrameScheduler as I3, map as _9, filter as $t, debounceTime as y2, startWith as M2, ReplaySubject as I2 } from "rxjs";
import { useRef as t1, createElement as M, forwardRef as I, useEffect as q, useMemo as Q, useState as G, useCallback as o3, memo as y9, createContext as M9, useContext as i3, useImperativeHandle as H2, Fragment as Nt, useLayoutEffect as $3, cloneElement as x2 } from "react";
import { jsx as f, Fragment as s3, jsxs as n1 } from "react/jsx-runtime";
import { useDependency as k, useObservable as d1, useInjector as S2, connectInjector as $1 } from "@wendellhu/redi/react-bindings";
export * from "@wendellhu/redi/react-bindings";
import { clsx as r1, isBrowser as R2, resizeObserverCtor as V2, Button as H3, DropdownMenu as N3, InputNumber as O2, TinyMenuGroup as E2, Menu as $2, MenuItem as D3, MenuItemGroup as T3, SubMenu as Dt, Tooltip as I9, MessageType as N2, KBD as D2, divideYClassName as T2, Dropdown as H9, divideXClassName as Tt, borderBottomClassName as ve, HoverCard as Z2, borderClassName as A2, Popup as x9, borderLeftBottomClassName as B2, scrollbarClassName as P2, ConfigProvider as S9, ConfigContext as F2, ColorPicker as k2, render as Ne, unmount as R9, Confirm as j2, Dialog as U2, Gallery as z2, Messager as W2, removeMessage as He, message as Y2, toast as G2, Toaster as X2 } from "@univerjs/design";
import { map as Zt } from "rxjs/operators";
import { IRenderManagerService as V9, UniverRenderEnginePlugin as O9, ptToPx as q2 } from "@univerjs/engine-render";
import { createPortal as E9 } from "react-dom";
class G3 extends v1 {
  constructor() {
    super(...arguments);
    F(this, "_open$", new X1(!1));
    F(this, "open$", this._open$.pipe(w9()));
  }
  get isOpen() {
...
const Pi = g1("ui.left-sidebar.service"), we = g1("ui.sidebar.service"), $9 = "ShortcutPanel", l3 = {
  id: "base-ui.operation.toggle-shortcut-panel",
  type: r3.OPERATION,
  handler: (e) => {
    const t = e.get(G3), n = e.get(we);
...
function H({ ref: e, ...t }) {
  const { icon: n, id: r, className: o, extend: s, ...i } = t, u = `univerjs-icon univerjs-icon-${r} ${o || ""}`.trim(), d = t1(`_${K2()}`);
  return N9(n, `${r}`, {
    defIds: n.defIds,
    idSuffix: d.current
  }, {
...
function N9(e, t, n, r, o) {
  return M(e.tag, {
    ...
    ...J2(e, n, o),
    ...r
  }, (Q2(e, n).children || []).map((s, i) => N9(s, `${t}-${e.tag}-${i}`, n, void 0, o)));
}
function J2(e, t, n) {
  const r = { ...e.attrs };
  n != null && n.colorChannel1 && r.fill === "colorChannel1" && (r.fill = n.colorChannel1), e.tag === "mask" && r.id && (r.id = r.id + t.idSuffix), Object.entries(r).forEach(([s, i]) => {
    s === "mask" && typeof i == "string" && (r[s] = i.replace(/url\(#(.*)\)/, `url(#$1${t.idSuffix})`));
  });
  const { defIds: o } = t;
  return !o || o.length === 0 || (e.tag === "use" && r["xlink:href"] && (r["xlink:href"] = r["xlink:href"] + t.idSuffix), Object.entries(r).forEach(([s, i]) => {
    typeof i == "string" && (r[s] = i.replace(/url\(#(.*)\)/, `url(#$1${t.idSuffix})`));
  })), r;
}
function Q2(e, t) {
  var r;
...
$6.displayName = "ReduceDigitsIcon";
const i0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
G6.displayName = "VerticalCenterIcon";
const w0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
en.displayName = "AutoWidthDoubleIcon";
const x0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
tn.displayName = "BackSlashDoubleIcon";
const S0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
rn.displayName = "ConditionsDoubleIcon";
const V0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
sn.displayName = "DeleteCellMoveDownDoubleIcon";
const E0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
ln.displayName = "DeleteCellShiftLeftDoubleIcon";
const $0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
an.displayName = "DeleteCellShiftRightDoubleIcon";
const N0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
un.displayName = "DeleteColumnDoubleIcon";
const T0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
fn.displayName = "FontColorDoubleIcon";
const B0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
pn.displayName = "InsertCellDownDoubleIcon";
const j0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
mn.displayName = "InsertCellShiftRightDoubleIcon";
const U0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Ln.displayName = "InsertRowAboveDoubleIcon";
const W0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
In.displayName = "LeftTridiagonalDoubleIcon";
const J0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
xn.displayName = "OuterBorderDoubleIcon";
const K0 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
$n.displayName = "RightInsertColumnDoubleIcon";
const i5 = {
  tag: "svg",
  attrs: {
    xmlns: "http://www.w3.org/2000/svg",
...
Tn.displayName = "VerticalBorderDoubleIcon";
const xe = {
  AddDigitsIcon: D9,
  AddImageIcon: T9,
  ...
  AutoWidthDoubleIcon: en,
  AutowrapIcon: j9,
  AvgIcon: U9,
  BackSlashDoubleIcon: tn,
  BoldIcon: z9,
  BrushIcon: W9,
  CancelFreezeIcon: Y9,
  CancelMergeIcon: G9,
  ...
  CntIcon: X9,
  CodeIcon: q9,
  ConditionsDoubleIcon: rn,
  CopyDoubleIcon: on,
  DeleteCellMoveDownDoubleIcon: sn,
  DeleteCellShiftLeftDoubleIcon: ln,
  DeleteCellShiftRightDoubleIcon: an,
  DeleteCellShiftUpDoubleIcon: cn,
  DeleteColumnDoubleIcon: un,
  ...
  InsertCellDownDoubleIcon: pn,
  InsertCellShiftRightDoubleIcon: mn,
  InsertDoubleIcon: bn,
  InsertRowAboveDoubleIcon: Ln,
  ...
  NoRotationIcon: x6,
  OrderIcon: S6,
  OuterBorderDoubleIcon: xn,
  OverflowIcon: R6,
  PaintBucketDoubleIcon: Sn,
  ...
  VerticalBorderDoubleIcon: Tn,
  VerticalCenterIcon: G6,
...
class S1 extends v1 {
  constructor() {
    ...
    this.disposeWithMe(h1(() => {
      for (const n in xe)
        this._components.delete(n), this._componentsReverse.delete(xe[n]);
    }));
  }
  register(n, r, o) {
    const { framework: s = "react" } = o || {};
    if (s === "vue3" && !this._handler.vue3)
    ...
    return this._components.has(n) && console.warn(`Component ${n} already exists.`), this._components.set(n, {
      framework: s,
      component: r
    }), this._componentsReverse.set(r, n), h1(() => {
...
j3 = new WeakMap(), U3 = new WeakMap(), L3(Pe, j3, 2147483647), L3(Pe, U3, -2147483647);
function Fi(e, t, n, r) {
  const o = e.get(A1);
  return new pe((s) => {
    const i = o.focused$.subscribe((v) => {
    ...
    return s.next(d !== t), () => i.unsubscribe();
  });
}
function ki(e) {
  const t = e.get(A1);
  return new pe((n) => {
    const r = t.focused$.subscribe((i) => {
      if (i == null)
        return n.next(!0);
      const u = t.getUniverDocInstance(i), d = u == null ? void 0 : u.getSnapshot().documentStyle.documentFlavor;
      n.next(d !== Ot.TRADITIONAL);
    }), o = t.getCurrentUniverDocInstance();
    if (o == null)
      return n.next(!0);
    const s = o == null ? void 0 : o.getSnapshot().documentStyle.documentFlavor;
    return n.next(s !== Ot.TRADITIONAL), () => r.unsubscribe();
  });
}
function a5(e, t) {
...
const h5 = (e) => {
  const { value: t, selections: n } = e, r = k(x1), o = Q(() => {
    var s, i;
    return t == null ? "" : r.t((i = (s = n.find((u) => u.value === t)) == null ? void 0 : s.label) != null ? i : "");
  }, [t, n]);
  return /* @__PURE__ */ f(
    "div",
    {
...
}, f5 = "UI_PLUGIN_COMMON_LABEL_COMPONENT";
function _1(e) {
  const { className: t, title: n, icon: r, label: o, value: s, value$: i } = e, u = k(x1), d = k(S1), [v, g] = G(s), [c, m] = G(""), L = [];
  let _ = 0;
  q(() => {
    if (i) {
  ...
  const O = Q(() => s != null ? s : v, [v, s]);
  q(() => {
    let y = null;
    return Be(r) ? y = r.subscribe((E) => {
      m(E);
    }) : m(r != null ? r : ""), () => {
      y == null || y.unsubscribe();
    };
  }, [r]);
  const S = Q(() => O && typeof O == "string" ? new E3(O).isValid : !1, [O]);
  if (r) {
    const y = d.get(c != null ? c : "");
    y && L.push(
      /* @__PURE__ */ f(
        y,
        {
          className: "univer-text-base",
          extend: { colorChannel1: S ? O : "var(--univer-primary-600)" }
        },
        _++
      )
    );
  ...
  if (o) {
    const y = typeof o == "string", E = y ? { ...e } : { ...o == null ? void 0 : o.props, ...e }, R = y ? o : o == null ? void 0 : o.name, B = d.get(R);
    B ? L.push(
      /* @__PURE__ */ f(
        B,
        {
  ...
  return n && L.push(
    /* @__PURE__ */ f("span", { className: t, children: typeof n == "string" ? u.t(n) : n }, _++)
  ), /* @__PURE__ */ f(s3, { children: L });
}
const C5 = (e) => {
  var s, i;
  const { value: t, text: n } = e, r = s2[t], o = k(x1);
  return /* @__PURE__ */ f(
    "span",
    {
      className: r1("univer-text-sm", {
        "univer-font-bold": r == null ? void 0 : r.bl
      }),
      style: {
        fontSize: r == null ? void 0 : r.fs,
        color: (i = (s = r == null ? void 0 : r.cl) == null ? void 0 : s.rgb) != null ? i : void 0
      },
      children: o.t(n)
    }
  );
}, v5 = "UI_COMPONENT_HEADING_ITEM";
function re(e) {
  const t = t1(e);
  return t.current = e, o3(
    ((...n) => {
      var r;
...
function g5(e, t) {
  const n = re(() => {
    if (!e || !t)
      return;
    const r = e.style, o = e.getBoundingClientRect(), { y: s, height: i } = o, u = t.getBoundingClientRect(), d = e.scrollHeight > i, v = s < 0 || s + i > u.height;
    if (!v && !d) {
      r.overflowY = "", r.maxHeight = "";
      return;
    }
    v && (r.overflowY = "auto", r.maxHeight = s < 0 ? `${e.scrollHeight + s}px` : `${u.height - s}px`);
  });
  q(() => {
    if (!R2() || !e || !t) return;
    n();
...
function ji(e) {
  k(x1);
  const { value: t, min: n = 0, max: r = 400, disabled: o = !1, resetPoint: s = 100, shortcuts: i, onChange: u } = e, d = t1(null), [v, g] = G(!1);
  function c() {
    o || u && u(s);
  }
  function m(y) {
  ...
  function _(y) {
    ...
    function B(T) {
      if (R) {
        let A = T.clientX - E.getBoundingClientRect().x;
        A <= 0 ? A = 0 : A >= Se && (A = Se);
        const U = A / Se;
        let Y = 0;
        U <= 0.5 ? Y = n + U * (s - n) * 2 : Y = s + (U - 0.5) * (r - s) * 2, u && u(Math.ceil(Y));
      }
    }
    function w() {
      R = !1, document.removeEventListener("pointermove", B), window.removeEventListener("pointerup", w);
    }
    function $(T) {
      T.relatedTarget === null && w();
    }
    window.addEventListener("pointermove", B), window.addEventListener("pointerup", w), window.addEventListener("pointerout", $);
  }
  function O(y) {
    o || (g(!1), u && u(y));
  }
  const S = [{
    type: "radio",
    value: t.toString(),
    options: i.map((y) => ({ value: y.toString(), label: `${y}%` })),
    onSelect: (y) => O(+y)
  }];
  return /* @__PURE__ */ n1(
    "div",
    {
      className: r1("univer-flex univer-select-none univer-items-center univer-gap-1", {
      ...
      children: [
        ...
        /* @__PURE__ */ f(
          "div",
          {
            ...
            children: /* @__PURE__ */ n1("div", { ref: d, role: "track", className: "univer-relative univer-h-0.5", children: [
              /* @__PURE__ */ f(
                "a",
                {
              ...
              /* @__PURE__ */ f(
                "button",
                {
                  className: r1("univer-absolute univer-top-[calc(50%-6px)] univer-size-3 -univer-translate-x-1/2 univer-rounded-full univer-border-none univer-bg-white univer-shadow univer-transition-colors", {
...
const m5 = "UI_COLOR_PICKER_COMPONENT", b5 = (e) => {
  const { value: t } = e, n = k(x1), r = Q(() => {
    if (t == null) return "";
  ...
  const { value: t } = e, n = k(x1);
  return /* @__PURE__ */ f("span", { className: "univer-text-sm", style: { fontFamily: t }, children: n.t(`fontFamily.${`${t != null ? t : ""}`.replace(/\s/g, "")}`) });
}, w5 = "UI_FONT_FAMILY_COMPONENT", _5 = "UI_FONT_FAMILY_ITEM_COMPONENT", Ui = [
  {
    value: "Arial"
  },
  {
  ...
  const { value: t, min: n, max: r, onChange: o, disabled$: s } = e, i = d1(s), [u, d] = G(Number(t != null ? t : 0)), v = Q(() => Number(t != null ? t : u), [t]);
  function g(m) {
    m !== null && d(m);
  }
  function c(m) {
    m.stopPropagation(), m.code === "Enter" && o(u.toString());
  }
  return /* @__PURE__ */ f("div", { className: "univer-h-6 univer-w-7 univer-text-sm", children: /* @__PURE__ */ f(
    O2,
    {
...
], M5 = "UI_FONT_SIZE_COMPONENT", Yi = (e, t) => {
  const n = t1(!1);
  q(() => {
    if (n.current)
      return e();
...
const qi = (e, t) => {
  const { containerTarget: n, itemHeight: r, overscan: o = 5 } = t, s = I5(r), [i, u] = G(null), d = t1(!1), [v, g] = G([]), [c, m] = G({ height: void 0, marginTop: void 0 }), L = (R, B) => {
    if (typeof s.current == "number")
      return Math.ceil(R / s.current);
    let w = 0, $ = 0;
    for (let T = B; T < e.length; T++) {
      const W = s.current(T, e[T]);
      if (w += W, $ = T, w >= R)
        break;
    }
    return $ - B;
    ...
    return w + 1;
  }, O = (R) => typeof s.current == "number" ? R * s.current : e.slice(0, R).reduce((w, $, T) => w + s.current(T, e[T]), 0), S = Q(() => At(s.current) ? e.length * s.current : e.reduce(
    (R, B, w) => R + s.current(w, e[w]),
    0
  ), [e]), y = () => {
    const R = n.current;
    if (R) {
      const { scrollTop: B, clientHeight: w } = R, $ = _(B), T = L(w, $), W = Math.max(0, $ - o), A = Math.min(e.length, $ + T + o), U = O(W);
      m({
        height: `${S - U}px`,
        marginTop: `${U}px`
      }), g(
  ...
  return q(() => {
    if (n.current) {
      const R = () => {
        const w = n.current.clientWidth, $ = n.current.clientHeight;
        (w !== (i == null ? void 0 : i.width) || $ !== (i == null ? void 0 : i.height)) && u({ width: w, height: $ });
      };
      R();
    ...
    v,
    {
      ...
      scrollTo: re((R) => {
        const B = n.current;
        B && (d.current = !0, B.scrollTop = O(R), y());
      }),
      containerProps: {
        onScroll: (R) => {
          if (d.current) {
...
var H5 = Object.getOwnPropertyDescriptor, x5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? H5(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, Bt = (e, t) => (n, r) => t(n, r, e);
const S5 = "FOCUSING_UNIVER", R5 = [
  "app-layout",
  // 'univer-toolbar-btn',
  // 'univer-menu-item',
  "button",
  ...
  "render-canvas",
  "workbench-layout"
], U1 = g1("ui.layout-service");
let Fe = class extends v1 {
  constructor(t, n) {
    super();
  ...
  focus() {
    ...
    if (!t)
      return;
    let n;
    t instanceof l2 ? n = this._focusHandlers.get(w3.UNIVER_SHEET) : t instanceof u9 ? n = this._focusHandlers.get(w3.UNIVER_DOC) : t instanceof a2 && (n = this._focusHandlers.get(w3.UNIVER_SLIDE)), n && n(t.getUnitId());
  }
  registerFocusHandler(t, n) {
    ...
    return this._focusHandlers.set(t, n), h1(() => this._focusHandlers.delete(t));
  }
  registerContentElement(t) {
    if (this._contentElements.indexOf(t) === -1)
      return this._contentElements.push(t), h1(() => Et(this._contentElements, t));
  ...
  registerContainerElement(t) {
    if (this._allContainers.indexOf(t) === -1)
      return this._allContainers.push(t), h1(() => Et(this._allContainers, t));
  ...
  _initUniverFocusListener() {
    this.disposeWithMe(
      L2(window, "focusin").subscribe((t) => {
        ...
        n && this.checkElementInCurrentContainers(n) ? this._isFocused = !0 : this._isFocused = !1, this._contextService.setContextValue(S5, this._isFocused), this._contextService.setContextValue(Ze, Pt());
      })
    );
  }
  _initEditorStatus() {
    this._contextService.setContextValue(Ze, Pt());
  }
};
Fe = x5([
  Bt(0, be),
...
var H1 = /* @__PURE__ */ ((e) => (e[e.BUTTON = 0] = "BUTTON", e[e.SELECTOR = 1] = "SELECTOR", e[e.BUTTON_SELECTOR = 2] = "BUTTON_SELECTOR", e[e.SUBITEMS = 3] = "SUBITEMS", e))(H1 || {}), ke = /* @__PURE__ */ ((e) => (e.RIBBON = "ribbon", e.CONTEXT_MENU = "contextMenu", e))(ke || {}), w1 = /* @__PURE__ */ ((e) => (e.START = "ribbon.start", e.INSERT = "ribbon.insert", e.FORMULAS = "ribbon.formulas", e.DATA = "ribbon.data", e.VIEW = "ribbon.view", e.OTHERS = "ribbon.others", e))(w1 || {}), G1 = /* @__PURE__ */ ((e) => (e.HISTORY = "ribbon.start.history", e.FORMAT = "ribbon.start.format", e.LAYOUT = "ribbon.start.layout", e.OTHERS = "ribbon.start.others", e))(G1 || {}), De = /* @__PURE__ */ ((e) => (e.EDIT = "ribbon.insert.edit", e.MEDIA = "ribbon.insert.media", e.OTHERS = "ribbon.insert.others", e))(De || {}), A3 = /* @__PURE__ */ ((e) => (e.BASIC = "ribbon.formulas.basic", e.OTHERS = "ribbon.formulas.others", e))(A3 || {}), fe = /* @__PURE__ */ ((e) => (e.FORMULAS = "ribbon.data.formulas", e.RULES = "ribbon.data.rules", e.ORGANIZATION = "ribbon.data.organization", e.OTHERS = "ribbon.data.others", e))(fe || {}), Te = /* @__PURE__ */ ((e) => (e.DISPLAY = "ribbon.view.display", e.VISIBILITY = "ribbon.view.Visibility", e.OTHERS = "ribbon.view.others", e))(Te || {}), Zn = /* @__PURE__ */ ((e) => (e.OTHERS = "ribbon.others.others", e))(Zn || {}), Y1 = /* @__PURE__ */ ((e) => (e.MAIN_AREA = "contextMenu.mainArea", e.COL_HEADER = "contextMenu.colHeader", e.ROW_HEADER = "contextMenu.rowHeader", e.FOOTER_TABS = "contextMenu.footerTabs", e.FOOTER_MENU = "contextMenu.footerMenu", e.PARAGRAPH = "contextMenu.paragraph", e))(Y1 || {}), a1 = /* @__PURE__ */ ((e) => (e.QUICK = "contextMenu.quick", e.FORMAT = "contextMenu.format", e.LAYOUT = "contextMenu.layout", e.DATA = "contextMenu.data", e.OTHERS = "contextMenu.others", e))(a1 || {}), V5 = Object.getOwnPropertyDescriptor, O5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? V5(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, Ft = (e, t) => (n, r) => t(n, r, e);
const B1 = g1("univer.menu-manager-service");
let je = class extends v1 {
  constructor(t, n) {
    super();
    F(this, "menuChanged$", new N1());
    F(this, "_menu", {
      [ke.RIBBON]: {
        [w1.START]: {
          order: 0,
  ...
  mergeMenu(t, n) {
    ...
    for (const [o, s] of Object.entries(r))
      if (o in t) {
        const i = o;
        r[i] = Ae({}, r[i], t[i]), this.menuChanged$.next();
      } else typeof s == "object" && this.mergeMenu(t, s);
  }
  appendRootMenu(t) {
    this._menu = Ae({}, this._menu, t), this.menuChanged$.next();
  }
  _buildMenuSchema(t) {
    const n = [];
    for (const [r, o] of Object.entries(t)) {
      ...
      if (typeof o == "object") {
        ...
        i.length > 0 && (s.children = i.sort((u, d) => u.order - d.order)), (s.item || s.children) && n.push(s);
      }
    }
    return n;
  }
  ...
  getFlatMenuByPositionKey(t) {
    ...
    function r(o) {
      return o.reduce((s, i) => i.children ? [...s, i, ...r(i.children)] : [...s, i], []);
    }
    return r(n);
  }
};
...
function E5(e) {
  const { item: t, onOptionSelect: n } = e, [r, o] = G([]), s = k(S1), i = k(x1);
  return q(() => {
    if (!t.children) return;
    const u = t.children.map((v) => {
      var g, c;
      return c2((c = (g = v.item) == null ? void 0 : g.activated$) != null ? c : Le(!1), !1);
    }), d = ce(u).subscribe((v) => {
      const g = v.map((c, m) => ({ actived: c, item: t.children[m].item.id })).filter((c) => c.actived);
      g.length === 0 ? o([]) : o(g.map((c) => c.item));
    });
    return () => {
      d.unsubscribe(), u.forEach((v) => {
        v.complete();
      });
    };
  }, [t]), t.children ? /* @__PURE__ */ f(
    E2,
    {
      items: t.children.map((u) => {
        var d, v;
        return {
          key: u.key,
          onClick: () => {
            ...
            n == null || n({
              ...
              tooltip: ((m = u.item) == null ? void 0 : m.tooltip) && i.t((L = u.item) == null ? void 0 : L.tooltip)
            });
          },
          className: "",
          Icon: s.get(u.item.icon),
          active: r.includes((v = (d = u.item) == null ? void 0 : d.id) != null ? v : "")
        };
      })
    }
  ) : null;
...
function An(e) {
  const { menuType: t, onOptionSelect: n } = e, r = k(x1), o = k(B1), s = Q(() => t ? o.getMenuByPositionKey(t) : [], [t, o]), [i, u] = G({}), d = Q(() => s.filter((v) => {
    var c;
    if (!v.children) return v;
    const g = ((c = v.key) == null ? void 0 : c.toString()) || "";
    return !i[g];
  }), [s, i]);
  return q(() => {
    const v = s.map((g) => {
      if (!g.children) return null;
      const c = g.children.map((m) => {
        var L, _;
        return (_ = (L = m.item) == null ? void 0 : L.hidden$) != null ? _ : Le(!1);
      });
      return ce(c).subscribe((m) => {
        const L = m.every((_) => _ === !0);
        u((_) => ({
          ..._,
          [g.key]: L
        }));
    ...
    return () => {
      v.forEach((g) => g == null ? void 0 : g.unsubscribe()), u({});
    };
  }, [s]), t ? d && d.map((v) => {
    var g;
    return v.item ? /* @__PURE__ */ f(
      jt,
      {
        menuItem: v.item,
        onClick: (c) => {
          n == null || n({ value: "", label: v.key, ...c });
        }
      },
      v.key
    ) : (g = v.children) != null && g.length ? v.key === a1.QUICK ? /* @__PURE__ */ f(E5, { item: v, onOptionSelect: n }, v.key) : /* @__PURE__ */ f(T3, { eventKey: v.key, title: v.title ? r.t(v.title) : void 0, children: v.children.map((c) => c.item && /* @__PURE__ */ f(
      jt,
      {
        menuItem: c.item,
        onClick: (m) => {
          n == null || n({ value: "", label: c.key, ...m });
        }
      },
      c.key
    )) }, v.key) : null;
...
function Bn(e) {
  ...
  return (s = t == null ? void 0 : t.map((i, u) => {
    var m, L, _;
    const d = `${o}-${(m = i.label) != null ? m : i.id}-${u}`, v = (O) => {
      r == null || r({ value: O, label: i == null ? void 0 : i.label, commandId: i == null ? void 0 : i.commandId });
    }, g = () => {
    ...
    return /* @__PURE__ */ f(D3, { disabled: i.disabled, eventKey: d, className: c, onClick: g, children: /* @__PURE__ */ n1(
      "span",
      {
        className: r1(Ce, {
          "univer-relative univer-pl-5": !(typeof i.label != "string" && !((_ = i.label) != null && _.hoverable))
        }),
        children: [
          typeof n < "u" && String(n) === String(i.value) && /* @__PURE__ */ f("span", { className: "univer-absolute univer-left-0 univer-inline-flex univer-items-center", children: /* @__PURE__ */ f(X3, { className: "univer-text-primary-600" }) }),
          /* @__PURE__ */ f(
            _1,
            {
              value$: i.value$,
...
const $5 = (e) => {
  const { overViewport: t, style: n, ...r } = e, [o, s] = G(), i = k(U1);
  g5(t === "scroll" ? o : null, i.rootContainerElement);
  function u(d) {
    d && s(d.list);
  }
  return /* @__PURE__ */ n1(
...
function jt({ menuItem: e, onClick: t }) {
  const n = k(B1), r = d1(e.disabled$, !1), o = d1(e.activated$, !1), s = d1(e.hidden$, !1), i = d1(e.value$), u = e, d = d1(Be(u.selections) ? u.selections : void 0), [v, g] = G(i);
  if (q(() => {
    g(i);
  }, [i]), s)
    return null;
  const c = (S) => {
    const y = u2(S) && typeof S == "string" ? Number.parseInt(S) : S;
    g(y);
  }, m = () => {
    const S = e, { title: y, label: E } = S;
    return /* @__PURE__ */ f(
      D3,
      {
        eventKey: S.id,
        ...
        onClick: () => {
          t({ commandId: S.commandId, value: v, id: S.id });
        },
        children: /* @__PURE__ */ f("span", { className: Ce, children: /* @__PURE__ */ f(
          _1,
          {
            value: i,
            title: y,
    ...
    var y;
    const S = (y = d != null ? d : u.selections) != null ? y : [];
    return S.length > 0 ? /* @__PURE__ */ f(
      Dt,
      {
        eventKey: u.id,
        popupOffset: [18, 0],
        title: /* @__PURE__ */ n1("span", { className: Ce, children: [
          /* @__PURE__ */ f(
            _1,
            {
              title: u.title,
        ...
        expandIcon: /* @__PURE__ */ f(Z3, { className: kt }),
        children: /* @__PURE__ */ f(T3, { children: S.length > 0 && /* @__PURE__ */ f(
          Bn,
          {
            parentKey: u.id,
            menuType: u.id,
            options: S,
            onOptionSelect: (E) => {
              t({ value: E.value, id: u.id, commandId: E.commandId });
            }
          }
        ) })
      },
      u.id
    ) : /* @__PURE__ */ f(D3, { eventKey: u.id, children: /* @__PURE__ */ n1("span", { className: Ce, children: [
      /* @__PURE__ */ f(
        _1,
        {
          title: u.title,
  ...
  }, _ = e.id ? n.getMenuByPositionKey(e.id) : [], O = () => {
    const S = e;
    return /* @__PURE__ */ f(
      Dt,
      {
        eventKey: S.id,
        popupOffset: [18, 0],
        title: /* @__PURE__ */ f("span", { className: Ce, children: /* @__PURE__ */ f(_1, { title: S.title, icon: S.icon, label: S.label, onChange: c }) }),
        expandIcon: /* @__PURE__ */ f(Z3, { className: kt }),
        children: /* @__PURE__ */ f(T3, { children: _.length && /* @__PURE__ */ f(An, { menuType: S.id, parentKey: S.id, onOptionSelect: t }) })
      },
      S.id
    );
  };
  return /* @__PURE__ */ n1(s3, { children: [
    e.type === H1.SELECTOR && L(),
    e.type === H1.SUBITEMS && O(),
    e.type === H1.BUTTON && m()
  ] });
}
function Qi(e) {
  const { barColor: t, progress: n, onTerminate: r, onClearProgress: o } = e, { count: s, done: i, label: u = "" } = n, d = t1(null), [v, g] = G(!1);
  return q(() => {
    const c = d.current;
    if (s === 0 && i === 0) {
      g(!1), c.style.width = "0%";
    ...
    return c.addEventListener("transitionend", m), () => {
      c.removeEventListener("transitionend", m);
    };
  }, [s, i]), /* @__PURE__ */ n1(
    "div",
    {
      className: r1("univer-mx-2 univer-flex univer-items-center univer-gap-2", {
        "univer-flex": v,
        "univer-hidden univer-w-0": !v
      }),
      children: [
        /* @__PURE__ */ f(I9, { showIfEllipsis: !0, title: u, children: /* @__PURE__ */ f("span", { className: "univer-w-24 univer-truncate univer-text-right univer-text-xs", children: u }) }),
...
const Ki = "UNI_DISABLE_CHANGING_FOCUS", _e = "ui.config", Ue = {}, et = g1("ui.message.service");
var N5 = Object.getOwnPropertyDescriptor, D5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? N5(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, Ut = (e, t) => (n, r) => t(n, r, e);
let oe = class extends v1 {
  constructor(e, t) {
...
const Pn = (e, t) => {
  const n = e.get(h2), r = e.get(be);
  return ce([
    n.undoRedoStatus$.pipe(Zt((o) => t ? o.undos <= 0 : o.redos <= 0)),
    w2([Le({}), r.contextChanged$])
  ]).pipe(Zt(([o]) => o || r.getContextValue(d9) || r.getContextValue(h9)));
};
function Z5(e) {
  return {
    id: W3.id,
...
const B5 = {
  ...
  preconditions: () => !1,
  handler: () => !0
}, e7 = "sheet.command.paste-by-short-key";
...
var L1 = /* @__PURE__ */ ((e) => (e[e.SHIFT = 1024] = "SHIFT", e[e.ALT = 2048] = "ALT", e[e.CTRL_COMMAND = 4096] = "CTRL_COMMAND", e[e.MAC_CTRL = 8192] = "MAC_CTRL", e))(L1 || {});
function F5(e, t, n) {
  return window.addEventListener(e, t, n), h1(() => window.removeEventListener(e, t, n));
}
const tt = g1("ui.platform.service");
class Un {
  get isMac() {
...
var k5 = Object.getOwnPropertyDescriptor, j5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? k5(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, Re = (e, t) => (n, r) => t(n, r, e);
const ye = g1("ui.shortcut.service");
let ze = class extends v1 {
  constructor(t, n, r, o) {
    super();
    F(this, "_shortCutMapping", /* @__PURE__ */ new Map());
    F(this, "_commandIDMapping", /* @__PURE__ */ new Map());
    F(this, "_shortcutChanged$", new N1());
  ...
  registerShortcut(t) {
    ...
    const o = t.id, s = this._commandIDMapping.get(o);
    return s ? s.add(t) : this._commandIDMapping.set(o, /* @__PURE__ */ new Set([t])), this._emitShortcutChanged(), h1(() => {
      var i, u, d, v;
      (i = this._shortCutMapping.get(n)) == null || i.delete(t), ((u = this._shortCutMapping.get(n)) == null ? void 0 : u.size) === 0 && this._shortCutMapping.delete(n), (d = this._commandIDMapping.get(o)) == null || d.delete(t), ((v = this._commandIDMapping.get(o)) == null ? void 0 : v.size) === 0 && this._commandIDMapping.delete(o), this._emitShortcutChanged();
    });
  }
  ...
  getShortcutDisplay(t) {
    ...
    const n = this._getBindingFromItem(t);
    if (!n) return null;
    const r = n & L1.CTRL_COMMAND, o = n & L1.SHIFT, s = n & L1.ALT, i = n & L1.MAC_CTRL, u = (d = P5[n & 255]) != null ? d : "<->";
    return this._platformService.isMac ? `${r ? "⌘+" : ""}${o ? "⇧+" : ""}${s ? "⌥+" : ""}${i ? "⌃+" : ""}${u}` : `${r ? "Ctrl+" : ""}${o ? "Shift+" : ""}${s ? "Alt+" : ""}${u}`;
  }
  _emitShortcutChanged() {
    this._shortcutChanged$.next();
  }
  forceEscape() {
    return this._forceEscaped = !0, h1(() => this._forceEscaped = !1);
  }
  forceDisable() {
    return this._forceDisabled = !0, h1(() => {
  ...
  dispatch(t) {
    ...
    if (n === null)
      return;
    const r = this._shortCutMapping.get(n);
    return r === void 0 ? void 0 : Array.from(r).sort((s, i) => {
      var u, d;
      return ((u = i.priority) != null ? u : 0) - ((d = s.priority) != null ? d : 0);
    }).find((s) => {
      var i, u;
      return (u = (i = s.preconditions) == null ? void 0 : i.call(s, this._contextService)) != null ? u : !0;
    });
  }
  ...
  _deriveBindingFromEvent(t) {
    const { shiftKey: n, metaKey: r, altKey: o, keyCode: s } = t;
    let i = s;
    return n && (i |= L1.SHIFT), o && (i |= L1.ALT), (this._platformService.isMac ? r : t.ctrlKey) && (i |= L1.CTRL_COMMAND), this._platformService.isMac && t.ctrlKey && (i |= L1.MAC_CTRL), i;
  }
};
ze = j5([
  Re(0, ae),
...
var U5 = Object.getOwnPropertyDescriptor, z5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? U5(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, Gt = (e, t) => (n, r) => t(n, r, e);
function zn(e) {
  return e.getContextValue(Ze);
}
function Wn(e) {
  return e.getContextValue(Ze) && !(e.getContextValue(d9) || e.getContextValue(h9));
}
const W5 = {
  id: Fn.id,
...
let ie = class extends v1 {
  ...
  _registerShortcuts() {
    const e = [X5, q5];
    e.push(Y5, W5, G5), e.forEach((t) => this.disposeWithMe(this._shortcutService.registerShortcut(t)));
  }
};
ie = z5([
  Gt(0, ye),
...
function J5() {
  const e = k(ye), t = k(x1), n = d1(t.currentLocale$), [r, o] = G([]), s = o3(() => {
    var v;
    ...
    for (const g of u) {
      ...
      i.has(c) || i.set(c, []), i.get(c).push(m);
    }
    const d = Array.from(i.entries()).map(([g, c]) => {
      ...
      return {
        sequence: +m,
        name: t.t(L),
        items: f2(c, (_) => _.title + _.shortcut)
      };
  ...
  return q(() => {
    s();
    const i = e.shortcutChanged$.subscribe(() => s());
    return () => i.unsubscribe();
  }, [e, s]), /* @__PURE__ */ f(
    "ul",
    {
      className: "univer-m-0 univer-list-none univer-p-0 univer-text-gray-900 dark:!univer-text-white",
      children: r.map((i) => /* @__PURE__ */ n1("li", { children: [
        /* @__PURE__ */ f("div", { className: "univer-flex univer-h-10 univer-items-center univer-text-sm univer-font-semibold", children: i.name }),
        /* @__PURE__ */ f(
          "ul",
          {
            className: r1("univer-list-none univer-p-0", T2),
            children: i.items.map((u) => /* @__PURE__ */ n1(
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ f("span", { className: "univer-line-clamp-2", children: u.title }),
                  u.shortcut && /* @__PURE__ */ f(D2, { keyboard: u.shortcut })
                ]
              },
              `${u.title}-${u.shortcut}`
            ))
...
var Q5 = Object.getOwnPropertyDescriptor, K5 = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Q5(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, he = (e, t) => (n, r) => t(n, r, e);
const eo = {
...
let se = class extends v1 {
  constructor(e, t, n, r, o) {
    super(), this._menuManagerService = r, this.disposeWithMe(t.register($9, J5)), this.disposeWithMe(o.registerCommand(l3)), this.disposeWithMe(n.registerShortcut(eo));
  }
};
se = K5([
  he(0, m1(V1)),
...
var c1 = /* @__PURE__ */ ((e) => (e.GLOBAL = "global", e.HEADER = "header", e.HEADER_MENU = "header-menu", e.CONTENT = "content", e.FOOTER = "footer", e.LEFT_SIDEBAR = "left-sidebar", e.FLOATING = "floating", e.UNIT = "unit", e.CUSTOM_HEADER = "custom-header", e.CUSTOM_LEFT = "custom-left", e.CUSTOM_RIGHT = "custom-right", e.CUSTOM_FOOTER = "custom-footer", e.TOOLBAR = "toolbar", e))(c1 || {});
const D1 = g1("ui.parts.service");
class Yn extends v1 {
  constructor() {
    super(...arguments);
    F(this, "_componentsByPart", /* @__PURE__ */ new Map());
    F(this, "_componentRegistered$", new N1());
    F(this, "componentRegistered$", this._componentRegistered$.asObservable());
    F(this, "_uiVisible", /* @__PURE__ */ new Map());
    F(this, "_uiVisibleChange$", new N1());
  ...
  registerComponent(n, r) {
    const o = r(), s = (this._componentsByPart.get(n) || this._componentsByPart.set(n, /* @__PURE__ */ new Set()).get(n)).add(o);
    return this._componentRegistered$.next(n), h1(() => {
      s.delete(o), s.size === 0 && this._componentsByPart.delete(n), this._componentRegistered$.next(n);
    });
  }
  getComponents(n) {
...
const to = y9((e) => {
  ...
  ), [t.position$]), o = k(A1), s = d1(Q(() => t.position$.pipe(_2()), [t.position$])), i = t1(null), u = t1(null), d = t1(`transform: rotate(${s == null ? void 0 : s.rotate}deg) translate(${s == null ? void 0 : s.startX}px, ${s == null ? void 0 : s.startY}px)`), v = t1((y = s == null ? void 0 : s.startY) != null ? y : 0), g = t1((E = s == null ? void 0 : s.startX) != null ? E : 0), c = t1({}), m = typeof t.componentKey == "string" ? k(S1).get(t.componentKey) : t.componentKey, L = Q(() => ({
    data: t.data,
    ...t.props
  }), [t.data, t.props]);
  q(() => {
    const R = t.position$.subscribe((w) => {
      var $;
      d.current = `rotate(${w.rotate}deg)`, v.current = w.startY, g.current = w.startX, i.current && (i.current.style.transform = d.current, i.current.style.top = `${v.current}px`, i.current.style.left = `${g.current}px`, i.current.style.opacity = `${($ = w.opacity) != null ? $ : 1}`);
    }), B = r.subscribe((w) => {
      if (i.current && (i.current.style.width = `${Math.max(w.endX - w.startX - 2, 0)}px`, i.current.style.height = `${Math.max(w.endY - w.startY - 2, 0)}px`), u.current) {
        ...
        u.current.style.width = $.width, u.current.style.height = $.height, u.current.style.left = $.left, u.current.style.top = $.top, u.current.style.right = $.right, u.current.style.bottom = $.bottom, c.current = $;
      }
    });
    return () => {
  ...
  const _ = o.getUnit(t.unitId), O = _ instanceof u9 ? _.getDisabled() : void 0, S = Q(() => m ? /* @__PURE__ */ f(
    m,
    {
      ...L,
      unitId: t.unitId,
  ...
  return s ? /* @__PURE__ */ f(
    "div",
    {
      ...
      style: {
        ...
        top: v.current,
        left: g.current,
        width: Math.max(s.endX - s.startX - 2, 0),
        height: Math.max(s.endY - s.startY - 2, 0),
        transform: d.current,
        overflow: "hidden",
        transformOrigin: "center center"
      },
      onPointerMove: (R) => {
        t.onPointerMove(R.nativeEvent);
      },
      onPointerDown: (R) => {
        t.onPointerDown(R.nativeEvent);
      },
      onPointerUp: (R) => {
        t.onPointerUp(R.nativeEvent);
      },
      onWheel: (R) => {
        t.onWheel(R.nativeEvent);
      },
      children: /* @__PURE__ */ f(
        "div",
        {
  ...
  var i;
  const t = k(A1), n = k(nt), r = d1(n.domLayers$), o = d1(t.focused$), s = e || o;
  return (i = r == null ? void 0 : r.filter((u) => u[1].unitId === s)) == null ? void 0 : i.map((u) => /* @__PURE__ */ f(
    to,
    {
      id: u[0],
      layer: u[1]
...
}, rt = g1("ui.popup.service");
class Xn extends v1 {
  constructor() {
    super(...arguments);
    F(this, "_popupMap", /* @__PURE__ */ new Map());
    F(this, "_popups$", new X1([]));
...
const qn = M9({ current: void 0 }), ee = 8;
function Jn(e) {
  const { position: t, width: n, height: r, containerHeight: o, containerWidth: s, direction: i = "vertical", noPushMinimumGap: u = !1 } = e, d = u ? -1 / 0 : ee, v = u ? 1 / 0 : o - r - ee, g = u ? -1 / 0 : ee, c = u ? 1 / 0 : s - n - ee;
  if (i === "vertical" || i.indexOf("top") === 0 || i.indexOf("bottom") === 0) {
    const { left: E, top: R, right: B, bottom: w } = t, $ = i === "vertical" && w > v || i.indexOf("top") > -1 ? { top: Math.max(R - r, d) } : { top: Math.min(w, v) };
    let T;
  ...
  if (i.includes("center")) {
    const R = (O - L - r) / 2;
    y = Math.max(L + R, d) + r > o ? { top: Math.max(Math.min(v, O - r - R), d) } : { top: Math.max(d, Math.min(L + R, v)) };
  } else i.includes("top") ? y = {
    top: Math.min(L, v)
  } : i.includes("bottom") ? y = {
    top: Math.max(O - r, d)
  } : y = L + r > o ? Math.max(O - r, d) < ee ? { top: Math.min(L, v) } : { top: Math.max(O - r, d) } : { top: Math.min(L, v) };
  return { ...y, ...S };
}
function ot(e) {
  var j;
  const {
    ...
    noPushMinimumGap: y,
    autoRelayout: E = !0
  } = e, R = t1(null), B = re(i != null ? i : (() => {
  })), w = re(L != null ? L : (() => {
  })), $ = t1({
    top: -9999,
    left: -9999
  }), T = d, W = k(le), A = t1(void 0), U = W.getConfig(_e), Y = (j = U == null ? void 0 : U.popupRootId) != null ? j : "univer-popup-portal", X = re((z) => {
    requestAnimationFrame(() => {
      if (!R.current) return;
      const { clientWidth: e1, clientHeight: u1 } = R.current, b1 = window.innerWidth, y1 = window.innerHeight;
      $.current = Jn(
        {
          position: z,
          width: e1,
      ...
      ), R.current.style.top = `${$.current.top}px`, R.current.style.left = `${$.current.left}px`;
    });
  });
  q(() => {
    let z;
    return R.current && (z = new ResizeObserver(() => {
      E && A.current && X(A.current);
    }), z.observe(R.current)), () => {
      z == null || z.disconnect();
    };
  }, [R.current, E]), q(() => {
    const z = o.subscribe((e1) => {
      A.current = e1, X(e1);
    });
    ...
    const z = (e1) => {
      var O1;
      if (u && (u.indexOf(e1.target) > -1 || u.some(
        (l1) => l1.contains(e1.target)
      )))
        return;
      const u1 = e1.clientX, b1 = e1.clientY, y1 = [...(O1 = T == null ? void 0 : T.current) != null ? O1 : []];
      A.current && y1.push(A.current);
      for (const l1 of y1)
        if (u1 <= l1.right && u1 >= l1.left && b1 <= l1.bottom && b1 >= l1.top)
          return;
      B(e1);
    };
    return window.addEventListener("pointerdown", z), () => {
      window.removeEventListener("pointerdown", z);
    };
  }, [B, u, T]), q(() => {
    const z = (e1) => {
      e1.ctrlKey && e1.button === 0 || w();
    };
    return window.addEventListener("contextmenu", z), () => {
      window.removeEventListener("contextmenu", z);
    };
  }, [w]);
  const K = /* @__PURE__ */ n1(s3, { children: [
    t && /* @__PURE__ */ f(
      "div",
      {
    ...
    /* @__PURE__ */ f(
      "section",
      {
        ...
        ref: R,
        className: r1("univer-pointer-events-auto univer-fixed univer-left-[-9999px] univer-top-[-9999px] univer-z-[1020]", {
          "univer-hidden": m,
          "univer-animate-in univer-fade-in-70": !m
        }),
        style: { ...$.current, zIndex: _ },
        onPointerDown: (z) => z.stopPropagation(),
        onClick: c,
        onPointerEnter: v,
        onPointerLeave: g,
        children: /* @__PURE__ */ f(qn.Provider, { value: A, children: r })
      }
    )
  ] });
  return n ? document.getElementById(Y) ? E9(K, document.getElementById(Y)) : null : K;
}
ot.calcPopupPosition = Jn;
ot.useContext = () => i3(qn);
const no = ({ popup: e, children: t }) => {
  const [n, r] = G(!1), o = Q(() => e.anchorRect$.pipe(
    M3(0, I3),
    _9((c) => {
      var E;
      const { bottom: m, left: L, right: _, top: O } = c, [S = 0, y = 0] = (E = e.offset) != null ? E : [];
      return {
        left: L - S,
        right: _ + S,
        top: O - y,
  ...
  ), [e.anchorRect$, e.offset]), s = Q(() => {
    var c, m;
    return (m = (c = e.hiddenRects$) == null ? void 0 : c.pipe(M3(0, I3))) != null ? m : Le([]);
  }, [e.hiddenRects$]), i = Q(() => {
    var c;
    return (c = e.excludeRects$) == null ? void 0 : c.pipe(M3(0, I3));
  }, [e.excludeRects$]), u = d5(i, e.excludeRects), { canvasElement: d, hideOnInvisible: v = !0, hiddenType: g = "destroy" } = e;
  return q(() => {
    if (!v)
      return;
    const c = ce([o, s]).subscribe(([m, L]) => {
      const _ = d.getBoundingClientRect(), { top: O, left: S, bottom: y, right: E } = _, R = m.bottom - m.top, B = m.right - m.left, w = L.some(($) => m.top >= $.top - 0.5 * R && m.bottom <= $.bottom + 0.5 * R && m.left >= $.left - 0.5 * B && m.right <= $.right + 0.5 * B);
      m.bottom < O || m.top > y || m.right < S || m.left > E || w ? r(!0) : r(!1);
    });
    return () => c.unsubscribe();
  }, [d, v, o, s]), n && g === "destroy" ? null : /* @__PURE__ */ f(
    ot,
    {
      ...e,
      hidden: n,
      ...
      ...e.customActive ? null : {
        onPointerEnter: () => {
          var c;
          return (c = e.onActiveChange) == null ? void 0 : c.call(e, !0);
        },
        onPointerLeave: () => {
          var c;
          return (c = e.onActiveChange) == null ? void 0 : c.call(e, !1);
        }
      },
      onClick: e.onClick,
...
function Qn() {
  ...
  return d1(e.popups$, void 0, !0).map((r) => {
    const [o, s] = r, i = t.get(s.componentKey);
    return /* @__PURE__ */ f(
      no,
      {
        popup: s,
        children: i ? /* @__PURE__ */ f(i, { popup: s }) : null
      },
      o
    );
  });
...
function I1(e) {
  ...
  return !t || t.size === 0 ? n != null ? n : null : Array.from(t.values()).map((o, s) => {
    var i;
    return M(o, { key: `${(i = o.displayName) != null ? i : s}`, ...r });
  });
}
function M1(e, t) {
  var u;
  const n = (u = t == null ? void 0 : t.get(D1)) != null ? u : k(D1), r = Q(() => n.uiVisibleChange$.pipe($t((d) => d.ui === e)), [e, n]), o = d1(r), s = t1(0), i = d1(
  ...
  return Q(() => n.isUIVisible(e) ? n.getComponents(e) : /* @__PURE__ */ new Set(), [i]);
}
const Kn = `
...
function ro(e) {
  ...
  return /* @__PURE__ */ f(
    "button",
    {
      ...
      className: r1(Kn, {
        "univer-px-2": i,
        "!univer-bg-gray-200 dark:!univer-bg-gray-500": s
      }),
      style: r,
      disabled: o,
      onClick: g,
...
function oo(e) {
  const { disabled$: t, hidden$: n, activated$: r, value$: o } = e, [s, i] = G(), [u, d] = G(!1), [v, g] = G(!1), [c, m] = G(!1);
  return q(() => {
    const L = [];
    return t && L.push(t.subscribe((_) => d(_))), n && L.push(n.subscribe((_) => m(_))), r && L.push(r.subscribe((_) => g(_))), o && L.push(o.subscribe((_) => i(_))), () => L.forEach((_) => _.unsubscribe());
  }, [r, t, n, o]), { disabled: u, value: s, activated: v, hidden: c };
}
const it = M9({
  dropdownVisible: !1,
  ...
  const { children: n, ...r } = e, o = t1(null), [s, i] = G(!1), [u, d] = G(!1);
  function v(m) {
    i(u ? !1 : m);
  }
  function g(m) {
  ...
  return H2(t, () => ({
    ...
    I9,
    {
      ...
      onVisibleChange: v,
      ...r,
      children: /* @__PURE__ */ f("span", { ref: o, children: /* @__PURE__ */ f(it.Provider, { value: c, children: n }) })
    }
  ) : /* @__PURE__ */ f("span", { ref: o, children: n });
});
function so(e) {
  const { children: t, overlay: n, disabled: r, align: o = "start" } = e, { dropdownVisible: s, setDropdownVisible: i } = i3(it);
  function u(d) {
    i(d);
  }
  return /* @__PURE__ */ f(
    H9,
    {
      ...
      open: s,
      onOpenChange: u,
      children: /* @__PURE__ */ f("div", { className: "univer-h-full", onClick: (d) => d.stopPropagation(), children: t })
    }
  );
}
function Ve({ icon: e, value: t, option: n, onOptionSelect: r }) {
  var i;
  const o = (u) => {
    r == null || r({ value: u, label: n == null ? void 0 : n.label, commandId: n == null ? void 0 : n.commandId });
  }, s = typeof n.label == "string" || typeof n.label == "object" && ((i = n.label) == null ? void 0 : i.selectable) !== !1;
  return /* @__PURE__ */ n1(
    "div",
    {
      className: r1("univer-relative univer-flex univer-items-center univer-gap-2", {
        "univer-pl-6": s
      }),
      children: [
        s && String(t) === String(n.value) && /* @__PURE__ */ f(
          X3,
          {
...
function Xt({
  ...
  var O;
  const { dropdownVisible: u, setDropdownVisible: d } = i3(it), v = k(B1), [g, c] = G({}), m = Q(() => e ? v.getMenuByPositionKey(e) : [], [e]), L = Q(() => m.filter((S) => {
    var E;
    if (!S.children)
      return !g[S.key];
    const y = ((E = S.key) == null ? void 0 : E.toString()) || "";
    return !g[y];
  }), [m, g]);
  function _(S) {
    d(S);
  ...
  if (q(() => {
    ...
    return m.forEach((y) => {
      var E;
      if (y.children) {
        const R = y.children.map((w) => {
          var $, T;
          return (T = ($ = w.item) == null ? void 0 : $.hidden$) != null ? T : Le(!1);
        }), B = ce(R).subscribe((w) => {
          const $ = w.every((T) => T === !0);
          c((T) => ({
            ...T,
        ...
        S.push(B);
      } else if ((E = y.item) != null && E.hidden$) {
        const R = y.item.hidden$.subscribe((B) => {
          c((w) => ({
            ...w,
            [y.key]: B
          }));
      ...
      S.forEach((y) => y == null ? void 0 : y.unsubscribe()), c({});
    };
  }, [m]), t)
    return /* @__PURE__ */ f(
      so,
  ...
  if (r != null && r.length) {
    const S = r.map((y) => {
      ...
      return {
        type: "item",
        className: r1({
          "focus:univer-bg-white": typeof y.label != "string" && ((E = y.label) == null ? void 0 : E.hoverable) === !1
        }),
        children: /* @__PURE__ */ f(
          Ve,
          {
    ...
    for (const y of L) {
      if (!y.item) continue;
      const { title: E, id: R, commandId: B, icon: w } = y.item;
      if (!E)
    ...
    for (const y of L)
      ...
      } else (O = y.children) != null && O.length;
    return /* @__PURE__ */ f(
      N3,
      {
        align: "start",
...
const Oe = I((e, t) => {
  const n = k(x1), r = k(ae), o = k(U1), s = k(S1), { value: i, hidden: u, disabled: d, activated: v } = oo(e), g = (j, z) => {
    o.focus(), r.executeCommand(j, z);
  }, { tooltip: c, shortcut: m, icon: L, title: _, label: O, id: S, commandId: y, type: E, slot: R, params: B } = e, w = n.t(c != null ? c : "") + (m ? ` (${m})` : ""), { selections: $ } = e, T = Q(() => Be($) ? $ : new pe((j) => {
    j.next($);
  }), [$]), W = d1(T), A = Q(() => Be(L) ? L : new pe((j) => {
    var e1, u1;
    const z = (u1 = (e1 = W == null ? void 0 : W.find((b1) => b1.value === i)) == null ? void 0 : e1.icon) != null ? u1 : L;
    j.next(z);
  }), [L, W, i]), U = d1(A, void 0, !0);
  function Y(j) {
    var l1;
    const z = e.selectionsCommandId, e1 = y != null ? y : S, u1 = (l1 = z != null ? z : y) != null ? l1 : S;
    function b1(s1) {
      if (d) return;
      let p1 = u1;
      s1.id && (p1 = s1.id), g(p1, { value: s1.value });
    }
    function y1(s1) {
      d || g(u1, { value: s1 });
    }
    function O1() {
      d || j === H1.BUTTON_SELECTOR && g(e1, { value: i });
    }
    return j === H1.BUTTON_SELECTOR ? /* @__PURE__ */ n1(
      "div",
      {
        "data-u-command": S,
        "data-disabled": d,
        className: r1("univer-animate-in univer-fade-in univer-group univer-relative univer-flex univer-h-6 univer-cursor-pointer univer-items-center univer-rounded univer-pr-5 univer-text-sm univer-transition-colors hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", {
        ...
        children: [
          /* @__PURE__ */ f(
            "div",
            {
              className: r1("univer-relative univer-z-[1] univer-flex univer-h-full univer-items-center univer-rounded-l univer-px-1 univer-transition-colors hover:univer-bg-gray-200 dark:hover:!univer-bg-gray-600", {
          ...
          /* @__PURE__ */ f(
            Xt,
            {
              ...
              children: /* @__PURE__ */ f(
                "div",
                {
                  className: r1("univer-absolute univer-right-0 univer-top-0 univer-box-border univer-flex univer-h-6 univer-w-5 univer-items-center univer-justify-center univer-rounded-r univer-transition-colors hover:univer-bg-gray-200 dark:hover:!univer-bg-gray-600", {
                    "univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600": d,
                    "univer-bg-gray-200 dark:!univer-bg-gray-500": v,
                    "univer-bg-gray-100": v && d
                  }),
      ...
      Xt,
      {
        ...
        children: /* @__PURE__ */ n1(
          ...
          {
            "data-u-command": S,
            className: r1("univer-animate-in univer-fade-in univer-relative univer-flex univer-h-6 univer-cursor-pointer univer-items-center univer-gap-2 univer-whitespace-nowrap univer-rounded univer-px-1 univer-transition-colors hover:univer-bg-gray-100 dark:hover:!univer-bg-gray-700", {
              "univer-text-gray-900 dark:!univer-text-white": !d,
              "univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600": d,
            ...
            children: [
              ...
              /* @__PURE__ */ f(
                "div",
                {
                  className: r1("univer-flex univer-h-full univer-items-center", {
                    "univer-pointer-events-none univer-cursor-not-allowed univer-text-gray-300 dark:!univer-text-gray-600": d
                  }),
                  children: /* @__PURE__ */ f(me, {})
                }
  ...
  function X() {
    var z;
    const j = s.get(typeof O == "string" ? O : (z = O == null ? void 0 : O.name) != null ? z : "");
    return /* @__PURE__ */ f(
      ro,
      {
        "data-u-command": S,
        ...
        onClick: () => {
          var e1;
          return g((e1 = e.commandId) != null ? e1 : e.id, i != null ? i : B);
        },
        onDoubleClick: () => e.subId && g(e.subId),
        children: j ? /* @__PURE__ */ f(_1, { title: _, value: i, label: O }) : L ? /* @__PURE__ */ f(_1, { icon: L }) : /* @__PURE__ */ f(_1, { title: _ })
      }
    );
  }
  function K() {
...
function ao(e) {
  const { ribbonType: t, headerMenuComponents: n, headerMenu: r = !0 } = e, o = k(B1), s = k(A1), i = k(x1), [u, d] = G(0), v = d1(s.focused$);
  q(() => {
  ...
  const g = t1(null), c = t1({}), [m, L] = G([]), [_, O] = G(w1.START), [S, y] = G(!1), [E, R] = G([]), [B, w] = G(!1), $ = o3((A) => {
    c.current = {}, O(A.key), y(!1);
  }, []);
  q(() => {
    var X;
    const A = o.getMenuByPositionKey(ke.RIBBON), U = [], Y = [];
    for (const K of A)
      if (K.children) {
        for (const j of K.children)
          if (j.children)
            for (const z of j.children)
              (X = z.item) != null && X.hidden$ && (U.push(z.item.hidden$), Y.push(`${K.key}/${j.key}/${z.key}`));
      }
    ce(U).subscribe((K) => {
      var e1, u1, b1, y1, O1, l1;
      const j = [], z = K.map((s1, p1) => s1 ? Y[p1] : null).filter((s1) => !!s1);
      for (const s1 of A) {
        const p1 = { ...s1, children: [] };
        if ((e1 = s1.children) != null && e1.length)
          for (const R1 of s1.children) {
            const T1 = { ...R1, children: [] };
            let z1 = !0;
            if ((u1 = R1.children) != null && u1.length) {
              for (const J1 of R1.children) {
                const Q1 = `${s1.key}/${R1.key}/${J1.key}`;
                z.includes(Q1) || (b1 = T1.children) == null || b1.push(J1);
              }
              (y1 = T1.children) != null && y1.every((J1) => {
                var Q1;
                return ((Q1 = J1.children) == null ? void 0 : Q1.length) === 0;
              }) && (z1 = !1);
            }
            z1 && ((O1 = p1.children) == null || O1.push(T1));
          }
        (l1 = p1.children) != null && l1.length && p1.children.every((R1) => {
          var T1;
          return (T1 = R1.children) == null ? void 0 : T1.length;
        }) && j.push(p1);
      }
      if (t === "simple") {
        const s1 = [{ key: w1.START, children: [], order: 0 }];
        j.forEach((p1) => {
          var R1;
          (R1 = p1.children) == null || R1.forEach((T1) => {
            var z1;
            (z1 = s1[0].children) == null || z1.push(T1);
          });
        }), L(s1);
      } else
        L(j);
  ...
  const T = Q(() => {
    var X, K;
    const A = (K = (X = m.find((j) => j.key === _)) == null ? void 0 : X.children) != null ? K : [], U = [], Y = [];
    for (const j of A)
      if (j.children) {
        const z = j.children.filter((e1) => !E.includes(e1.key));
        z.length > 0 && U.push({
          ...j,
          children: z
        }), z.length < j.children.length && Y.push({
          ...j,
          children: j.children.filter((e1) => E.includes(e1.key))
        });
      }
    return {
      allGroups: A,
  ...
  q(() => {
    let A = null;
    const U = new ResizeObserver(C2((Y) => {
      for (const X of Y)
        w(!0), A = requestAnimationFrame(() => {
          var O1, l1;
          const { width: K } = X.contentRect, z = Object.values(c.current).sort((s1, p1) => s1.order - p1.order || s1.groupOrder - p1.groupOrder || s1.itemOrder - p1.itemOrder), e1 = [];
          let u1 = 32;
          const y1 = (((l1 = (O1 = m.find((s1) => s1.key === _)) == null ? void 0 : O1.children) != null ? l1 : []).length - 1) * 8;
          u1 += y1;
          for (const { el: s1, key: p1 } of z) {
            const { width: R1 } = s1.getBoundingClientRect();
            u1 += R1 + 8, u1 > K && e1.push(p1);
          }
          R(e1), w(!1);
        });
    }, 100));
    return U.observe(g.current), () => {
      A && cancelAnimationFrame(A), U.disconnect();
    };
  }, [m, _]);
  const W = Q(() => /* @__PURE__ */ f(
    "div",
    {
      "aria-hidden": "true",
      className: r1("univer-invisible univer-absolute -univer-left-[99999] -univer-top-[99999] univer-box-border univer-flex univer-h-10 univer-min-w-min univer-items-center univer-px-3 univer-opacity-0", {
        "univer-hidden": !B
      }, Tt, ve),
      children: T.allGroups.map((A, U) => {
        var Y, X;
        return (((Y = A.children) == null ? void 0 : Y.length) || A.item) && /* @__PURE__ */ f(Nt, { children: /* @__PURE__ */ f("div", { className: "univer-grid univer-shrink-0 univer-grid-flow-col univer-gap-2 univer-px-2", children: A.children && ((X = A.children) == null ? void 0 : X.map((K) => K.item && /* @__PURE__ */ f(
          Oe,
          {
            ...K.item,
            ref: (j) => {
              j != null && j.el && (c.current[K.key] = {
                el: j.el,
                key: K.key,
                order: U,
                groupOrder: A.order,
  ...
  return /* @__PURE__ */ n1(s3, { children: [
    r && n && n.size > 0 && /* @__PURE__ */ f("header", { className: r1("univer-relative univer-h-11 univer-select-none", ve), children: /* @__PURE__ */ f(
      "div",
      {
        ...
        children: /* @__PURE__ */ f(I1, { components: n })
      }
    ) }),
    /* @__PURE__ */ n1(
      "div",
      {
        className: r1("univer-box-border univer-grid univer-h-10 univer-grid-flow-col univer-items-center univer-px-3", {
          "univer-grid-cols-[auto,1fr]": m.length > 1,
          "univer-grid-cols-none": m.length === 1
        }, ve),
        children: [
          m.length > 1 && /* @__PURE__ */ f(
            Z2,
            {
              className: "univer-max-w-96 !univer-rounded-xl",
              align: "start",
              open: S,
              overlay: /* @__PURE__ */ f("div", { className: "univer-grid univer-gap-1 univer-px-2 univer-py-1", children: m.map((A) => {
                const U = lo[A.key];
                return /* @__PURE__ */ n1(
                  "a",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ f(
                        "span",
                        {
                          className: r1("univer-box-border univer-flex univer-size-9 univer-flex-shrink-0 univer-items-center univer-justify-center univer-rounded-lg", A2),
                          children: /* @__PURE__ */ f(
                            U,
                            {
                      ...
                      /* @__PURE__ */ n1("span", { className: "univer-flex univer-flex-col", children: [
                        /* @__PURE__ */ f(
                          "strong",
                          {
                        ...
                        /* @__PURE__ */ f("span", { className: "univer-text-xs univer-text-gray-400", children: i.t(`${A.key}Desc`) })
                      ] })
                    ]
                  },
                  A.key
          ...
          /* @__PURE__ */ n1(
            "div",
            {
              ...
              ref: g,
              className: r1("univer-flex univer-overflow-hidden", Tt),
              children: [
                T.visibleGroups.map((A) => {
                  var U, Y;
                  return (((U = A.children) == null ? void 0 : U.length) || A.item) && /* @__PURE__ */ f(Nt, { children: /* @__PURE__ */ f("div", { className: "univer-grid univer-shrink-0 univer-grid-flow-col univer-gap-2 univer-px-2", children: A.children && ((Y = A.children) == null ? void 0 : Y.map((X) => X.item && /* @__PURE__ */ f(Oe, { ...X.item }, X.key))) }) }, A.key);
                }),
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ f(
                      H9,
                      {
                            ...
                            children: T.hiddenGroups.map((A) => {
                              ...
                              return /* @__PURE__ */ f(
                                "div",
                                {
                                  ...
                                  children: /* @__PURE__ */ f("div", { className: "univer-flex univer-flex-wrap univer-gap-2", children: A.children ? (U = A.children) == null ? void 0 : U.map((Y) => Y.item && /* @__PURE__ */ f(Oe, { ...Y.item }, Y.key)) : A.item && /* @__PURE__ */ f(Oe, { ...A.item }, A.key) })
                                },
                                A.key
                              );
                            })
                        ...
                        children: /* @__PURE__ */ f("a", { className: Kn, type: "button", children: /* @__PURE__ */ f(Q3, {}) })
                      }
                    )
                  }
                )
...
class a3 extends v1 {
  ...
  injectThemeToHead(n) {
    function r(u, d = "--univer") {
      ...
      function g(c, m = "") {
        for (const L in c) {
          const _ = c[L], O = m ? `${m}-${L}` : L;
          typeof _ == "object" && _ !== null ? g(_, O) : v.push(`${d}-${O}: ${_};`);
        }
      }
      return g(u), v.join(`
`);
    }
    const o = r(n), s = document.getElementById(this._styleSheetId);
    s && s.remove();
...
const c3 = g1("ui.contextmenu.service");
class er extends v1 {
  constructor() {
    super(...arguments);
  ...
  registerContextMenuHandler(n) {
    ...
    return this._currentHandler = n, h1(() => this._currentHandler = null);
  }
}
function co() {
  const e = t1(null), [t, n] = G(!1), [r, o] = G(""), [s, i] = G([0, 0]), u = t1(t), d = k(c3), v = k(ae), g = S2();
  u.current = t, q(() => {
    ...
    function _(O) {
      e.current && !e.current.contains(O.target) && m();
    }
    return document.addEventListener("pointerdown", _), document.addEventListener("wheel", m), () => {
      document.removeEventListener("pointerdown", _), document.removeEventListener("wheel", m), L.dispose();
    };
  }, [d]);
  function c(L, _) {
    n(!1), requestAnimationFrame(() => {
      o(_), i([L.clientX, L.clientY]), n(!0);
    });
  }
  function m() {
    n(!1);
  }
  return /* @__PURE__ */ f(x9, { visible: t, offset: s, children: /* @__PURE__ */ f("section", { ref: e, children: r && /* @__PURE__ */ f(
    $5,
    {
      menuType: r,
      onOptionSelect: (L) => {
        const { label: _, commandId: O, value: S } = L;
        v && v.executeCommand(O != null ? O : _, { value: S }), g.get(U1).focus(), n(!1);
      }
    }
  ) }) });
}
const st = g1("univer.global-zone-service");
function tr() {
  const e = k(st), [t, n] = G(!1), r = d1(e.componentKey$, e.componentKey), o = k(S1), s = Q(() => {
  ...
  return q(() => {
    ...
    "section",
    {
      ...
      children: s && /* @__PURE__ */ f(s, {})
    }
  ) : null;
}
function nr() {
  const e = k(we), t = d1(e.sidebarOptions$), n = t1(null), r = Q(() => {
    if (!t)
      return null;
    const i = { ...t };
  ...
  function s() {
    ...
    e.options.visible = !1, e.sidebarOptions$.next(i), (u = i == null ? void 0 : i.onClose) == null || u.call(i);
  }
  return /* @__PURE__ */ f(
    "section",
    {
      "data-u-comp": "sidebar",
      className: r1("univer-relative univer-h-full univer-bg-white univer-text-gray-900 dark:!univer-bg-gray-900 dark:!univer-text-white", {
      ...
      children: /* @__PURE__ */ n1(
        ...
        {
          ref: n,
          className: r1("univer-box-border univer-grid univer-h-0 univer-min-h-full univer-grid-rows-[auto_1fr_auto] univer-overflow-y-auto", B2, P2),
          children: [
            /* @__PURE__ */ n1(
              "header",
              {
            ...
            /* @__PURE__ */ f("section", { className: "univer-box-border univer-px-4", style: r == null ? void 0 : r.bodyStyle, children: r == null ? void 0 : r.children }),
            (r == null ? void 0 : r.footer) && /* @__PURE__ */ f(
              "footer",
              {
...
const lt = g1("univer.zen-zone-service");
function rr() {
  const e = k(lt), [t, n] = G(!1), [r, o] = G(), s = d1(e.temporaryHidden$), i = k(S1);
  q(() => {
    const d = [
  ...
  return /* @__PURE__ */ f(
    "section",
    {
      className: r1("univer-absolute univer-z-[-1] univer-flex", {
        "univer-animate-in univer-fade-in univer-inset-0 univer-z-[100] univer-bg-gray-100": t,
        "univer-hidden": s
      }),
      children: /* @__PURE__ */ f("div", { className: "univer-relative univer-flex-1", children: u && /* @__PURE__ */ f(u, {}) })
    }
  );
}
function uo(e) {
  const t = p5(_e);
  return /* @__PURE__ */ f(ho, { ...e, ...t });
}
function ho(e) {
  var K;
  const {
    ...
    mountContainer: u,
    onRendered: d
  } = e, v = k(x1), g = k(Y3), c = k(a3), m = t1(null), _ = k(le).getConfig(_e), O = M1(c1.CUSTOM_HEADER), S = M1(c1.FOOTER), y = M1(c1.HEADER), E = M1(c1.HEADER_MENU), R = M1(c1.CONTENT), B = M1(c1.LEFT_SIDEBAR), w = M1(c1.GLOBAL), $ = M1(c1.TOOLBAR), T = (K = _ == null ? void 0 : _.popupRootId) != null ? K : "univer-popup-portal";
  $3(() => {
    const j = g.currentTheme$.subscribe((z) => {
      c.injectThemeToHead(z);
    });
    return () => {
      j.unsubscribe();
    };
  ...
  const [W, A] = G(!1);
  $3(() => {
    const j = g.darkMode$.subscribe((z) => {
      A(z), z ? document.documentElement.classList.add("univer-dark") : document.documentElement.classList.remove("univer-dark");
    });
    return () => {
      j.unsubscribe();
    };
  ...
  const [U, Y] = G(v.getLocales()), X = Q(() => document.createElement("div"), []);
  return q(() => {
    ...
    return () => {
      j.forEach((z) => z.unsubscribe()), document.body.removeChild(X);
    };
  }, [v, u, X]), /* @__PURE__ */ n1(S9, { locale: U == null ? void 0 : U.design, mountContainer: X, children: [
    /* @__PURE__ */ n1(
      "div",
      {
        "data-u-comp": "workbench-layout",
        className: r1("univer-flex univer-h-full univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800", {
          "univer-dark": W
        }),
        tabIndex: -1,
        ...
        children: [
          /* @__PURE__ */ f(
            "div",
            {
              ...
              children: /* @__PURE__ */ f(I1, { components: O }, "custom-header")
            }
          ),
          t && n && /* @__PURE__ */ f(
            "header",
          ...
          /* @__PURE__ */ n1("section", { className: "univer-relative univer-flex univer-min-h-0 univer-flex-1 univer-flex-col", children: [
            /* @__PURE__ */ n1(
              "div",
              {
                className: "univer-grid univer-h-full univer-grid-cols-[auto_1fr_auto] univer-grid-rows-[100%] univer-overflow-hidden",
                children: [
                  /* @__PURE__ */ f("aside", { "data-u-comp": "left-sidebar", className: "univer-h-full", children: /* @__PURE__ */ f(I1, { components: B }, "left-sidebar") }),
                  /* @__PURE__ */ n1(
                    "section",
                    {
                      className: r1("univer-relative univer-grid univer-flex-1 univer-grid-rows-[auto_1fr] univer-overflow-hidden univer-bg-white dark:!univer-bg-gray-800", ve),
                      children: [
                        /* @__PURE__ */ f("header", { children: t && /* @__PURE__ */ f(I1, { components: y }, "header") }),
                        /* @__PURE__ */ f(
                          "section",
                          {
                            ...
                            onContextMenu: (j) => j.preventDefault(),
                            children: /* @__PURE__ */ f(I1, { components: R }, "content")
                          }
                        )
                      ]
                    }
                  ),
                  /* @__PURE__ */ f("aside", { "data-u-comp": "right-sidebar", className: "univer-h-full", children: /* @__PURE__ */ f(nr, {}) })
                ]
              }
            ),
            r && /* @__PURE__ */ f("footer", { children: /* @__PURE__ */ f(I1, { components: S, sharedProps: { contextMenu: s } }, "footer") }),
            /* @__PURE__ */ f(rr, {})
          ] })
        ]
      }
    ),
    /* @__PURE__ */ f(I1, { components: w }, "global"),
    /* @__PURE__ */ f(tr, {}),
    s && /* @__PURE__ */ f(co, {}),
    /* @__PURE__ */ f(fo, {}),
    /* @__PURE__ */ f("div", { id: T })
...
function fo() {
  const { mountContainer: e } = i3(F2), t = M1(c1.FLOATING);
  return E9(/* @__PURE__ */ f(I1, { components: t }, "floating"), e);
}
const Co = 3e3;
class or extends v1 {
  constructor(n, r, o, s, i) {
    ...
    this._injector = n, this._instanceService = r, this._layoutService = o, this._lifecycleService = s, this._renderManagerService = i;
  }
  dispose() {
  ...
  _bootstrapWorkbench() {
    this.disposeWithMe(this.bootstrap(async (n, r) => {
      ...
      try {
        await this._lifecycleService.onStage(_3.Ready), this._renderTimeout = window.setTimeout(() => {
          const o = this._renderManagerService.getRenderAll();
          for (const [s] of o)
            if (this._changeRenderUnit(s, n)) break;
          this.disposeWithMe(this._instanceService.focused$.subscribe((s) => {
            s && this._changeRenderUnit(s, n);
          })), this.disposeWithMe(this._renderManagerService.created$.subscribe((s) => {
            var i;
            s.unitId === ((i = this._instanceService.getFocusedUnit()) == null ? void 0 : i.getUnitId()) && this._changeRenderUnit(s.unitId, n);
          })), this.disposeWithMe(this._renderManagerService.disposed$.subscribe((s) => {
            this._currentRenderId === s && (this._currentRenderId = null);
          })), this._lifecycleService.stage = _3.Rendered, this._steadyTimeout = window.setTimeout(() => {
            this._lifecycleService.stage = _3.Steady;
          }, Co);
        }, 300);
      } catch (o) {
        if (o instanceof v2)
  ...
  _changeRenderUnit(n, r) {
    ...
    if (!o || !o.unitId || g2(o.unitId)) return !1;
    const s = this._currentRenderId ? this._renderManagerService.getRenderById(this._currentRenderId) : null;
    return s == null || s.deactivate(), s == null || s.engine.unmount(), o.engine.mount(r), o.activate(), this._currentRenderId = n, !0;
  }
}
var vo = Object.getOwnPropertyDescriptor, go = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? vo(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, j1 = (e, t) => (n, r) => t(n, r, e);
let B3 = class extends or {
  constructor(e, t, n, r, o, s, i, u, d) {
    super(t, s, o, n, r), this._config = e, this._componentManager = d, i.mergeMenu(B5), this._initBuiltinComponents(u), this._registerComponents(), this._bootstrapWorkbench();
  }
  _registerComponents() {
    [
      [f5, h5],
  ...
  _initBuiltinComponents(e) {
    this.disposeWithMe(e.registerComponent(c1.FLOATING, () => $1(Qn, this._injector))), this.disposeWithMe(e.registerComponent(c1.CONTENT, () => $1(Gn, this._injector))), this.disposeWithMe(e.registerComponent(c1.TOOLBAR, () => $1(ao, this._injector)));
  }
};
B3 = go([
  j1(1, m1(V1)),
...
function po(e, t, n) {
  ...
  return u(), h1(() => {
    Ne(/* @__PURE__ */ f("div", {}), r), setTimeout(() => Ne(/* @__PURE__ */ f("div", {}), r), 200), setTimeout(() => R9(r), 500);
  });
}
function qt(e) {
...
const We = g1("univer.ui.ui-controller");
function mo(e) {
  const { menuType: t, onOptionSelect: n } = e, r = k(B1);
  if (!t)
    return null;
  const o = Q(() => {
    const s = r.getMenuByPositionKey(t);
    function i(u) {
      return u.reduce((d, v) => v.children ? [...d, ...i(v.children)] : [...d, v], []);
    }
    return i(s);
  }, [t]);
  return /* @__PURE__ */ f(
    "div",
    {
      ...
      children: o.map((s) => s.item && /* @__PURE__ */ f(
        bo,
        {
          menuItem: s.item,
          onClick: (i) => n == null ? void 0 : n({ value: "", label: s.key, ...i })
        },
        s.key
      ))
    }
...
function bo(e) {
  const { menuItem: t, onClick: n } = e, { id: r, type: o, title: s, label: i, icon: u } = t;
  if (o !== H1.BUTTON)
  ...
  return /* @__PURE__ */ f(
    ...
    {
      type: "button",
      className: r1("univer-w-18 univer-flex univer-flex-col univer-items-center univer-justify-center univer-border-none univer-bg-transparent univer-text-white [&>span]:univer-mt-0.5 [&>span]:univer-w-full [&>span]:univer-truncate [&>span]:univer-text-sm [&>svg]:univer-size-[18px] [&>svg]:univer-text-lg"),
      disabled: d,
      onClick: () => n({ id: r }),
      children: /* @__PURE__ */ f(_1, { value: v, title: s, label: i, icon: u })
    },
    r
  );
}
function Lo() {
  const [e, t] = G(!1), [n, r] = G(""), [o, s] = G([0, 0]), i = t1(e), u = k(c3), d = k(ae);
  i.current = e, q(() => {
  ...
  function v(c, m) {
    r(m), s([c.clientX, c.clientY]), t(!0);
  }
  function g() {
    t(!1);
  }
  return /* @__PURE__ */ f(x9, { visible: e, offset: o, children: /* @__PURE__ */ f("section", { onPointerDown: (c) => c.stopPropagation(), children: n && // TODO@wzhudev: change to mobile menu
  /* @__PURE__ */ f(
    mo,
    {
      menuType: n,
      onOptionSelect: (c) => {
        const { label: m, value: L, commandId: _ } = c;
        d && d.executeCommand(_ != null ? _ : m, { value: L }), t(!1);
      }
    }
  ) }) });
}
function wo(e) {
  const {
    ...
    mountContainer: o,
    onRendered: s
  } = e, i = k(x1), u = k(Y3), d = k(a3), v = t1(null), g = M1(c1.FOOTER), c = M1(c1.HEADER), m = M1(c1.CONTENT), L = M1(c1.LEFT_SIDEBAR), _ = M1(c1.GLOBAL), [O, S] = G(!1);
  q(() => {
    ...
    v.current && (s == null || s(v.current));
  }, [s]);
  const [y, E] = G(i.getLocales()), R = Q(() => document.createElement("div"), []);
  return $3(() => {
  ...
  }, [i, o, R]), /* @__PURE__ */ n1(S9, { locale: y == null ? void 0 : y.design, mountContainer: R, children: [
    /* @__PURE__ */ n1(
      "div",
      {
        "data-u-comp": "app-layout",
        className: r1("univer-relative univer-flex univer-h-full univer-min-h-0 univer-flex-col univer-bg-white dark:!univer-bg-gray-800", {
          "univer-dark": O
        }),
        tabIndex: -1,
        onBlur: (B) => B.stopPropagation(),
        children: [
          t && /* @__PURE__ */ f("header", { className: "univer-relative univer-z-10 univer-w-full" }),
          /* @__PURE__ */ n1("section", { className: "univer-relative univer-flex univer-min-h-0 univer-flex-1 univer-flex-col", children: [
            /* @__PURE__ */ n1(
              "div",
              {
                className: "univer-grid univer-h-full univer-grid-cols-[auto_1fr_auto] univer-grid-rows-[100%] univer-overflow-hidden",
                children: [
                  /* @__PURE__ */ f("aside", { className: "univer-h-full", children: /* @__PURE__ */ f(I1, { components: L }, "left-sidebar") }),
                  /* @__PURE__ */ n1(
                    "section",
                    {
                      className: r1("univer-relative univer-grid univer-flex-1 univer-grid-rows-[auto_1fr] univer-overflow-hidden univer-bg-white dark:!univer-bg-gray-800", ve),
                      children: [
                        /* @__PURE__ */ f("header", { className: "univer-w-screen", children: t && /* @__PURE__ */ f(I1, { components: c }, "header") }),
                        /* @__PURE__ */ f(
                          "section",
                          {
                            ref: v,
                            ...
                            children: /* @__PURE__ */ f(I1, { components: m }, "content")
                          }
                        )
                      ]
                    }
                  ),
                  /* @__PURE__ */ f("aside", { className: "univer-h-full", children: /* @__PURE__ */ f(nr, {}) })
                ]
              }
            ),
            n && /* @__PURE__ */ f("footer", { children: /* @__PURE__ */ f(I1, { components: g }, "footer") }),
            /* @__PURE__ */ f(tr, {}),
            /* @__PURE__ */ f(rr, {})
          ] })
        ]
    ...
    /* @__PURE__ */ f(I1, { components: _ }, "global"),
    r && /* @__PURE__ */ f(Lo, {})
  ] });
}
var _o = Object.getOwnPropertyDescriptor, yo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? _o(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, te = (e, t) => (n, r) => t(n, r, e);
let P3 = class extends or {
  constructor(e, t, n, r, o, s, i) {
    super(t, s, o, n, r), this._config = e, this._initBuiltinComponents(i), this._bootstrapWorkbench();
  }
  bootstrap(e) {
    return Mo(this._injector, this._config, e);
  }
  _initBuiltinComponents(e) {
    this.disposeWithMe(e.registerComponent(c1.CONTENT, () => $1(Qn, this._injector))), this.disposeWithMe(e.registerComponent(c1.CONTENT, () => $1(Gn, this._injector)));
  }
};
P3 = yo([
  te(1, m1(V1)),
...
const u3 = g1("ui.notification.service");
var Io = Object.getOwnPropertyDescriptor, Ho = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Io(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, xo = (e, t) => (n, r) => t(n, r, e);
const ir = g1("univer.ui.before-close-service");
let Ye = class {
  constructor(e) {
...
var Ro = Object.getOwnPropertyDescriptor, Vo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Ro(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, x3 = (e, t) => (n, r) => t(n, r, e);
const Qt = "text/plain", Kt = "text/html", Oo = "image/png", Eo = "image/jpeg", $o = "image/bmp", No = "image/webp", t7 = "image/svg+xml", n7 = /* @__PURE__ */ new Set([
  $o,
  Eo,
  No,
  Oo
...
let Ge = class extends v1 {
  ...
  async write(e, t) {
    ...
    try {
      return await navigator.clipboard.write([
        new ClipboardItem({
          [Qt]: new Blob([e], { type: Qt }),
          [Kt]: new Blob([t], { type: Kt })
        })
      ]);
    } catch (n) {
  ...
  _legacyCopyText(e) {
    const t = document.activeElement, n = Do();
...
const at = g1("univer.confirm-service");
class r7 {
  constructor() {
    F(this, "confirmOptions$", new N1());
  }
  dispose() {
...
const Zo = (e) => {
  const { children: t, onClose: n, onConfirm: r } = e, [o] = G({}), s = t ? x2(t, { hooks: o }) : null;
  return /* @__PURE__ */ f(
    j2,
    {
      ...e,
...
function Ao() {
  const e = k(at), [t, n] = G([]);
  q(() => {
    const o = e.confirmOptions$.subscribe((s) => {
      n(s);
    });
    return () => {
      o.unsubscribe();
  ...
  const r = t.map((o) => {
    const { children: s, title: i, ...u } = o, d = u;
    for (const v of ["children", "title"]) {
      const g = v, c = o[g];
      c && (d[g] = /* @__PURE__ */ f(_1, { ...c }));
    }
    return d;
  });
  return r == null ? void 0 : r.map((o, s) => /* @__PURE__ */ f(Zo, { ...o, children: o.children }, s));
}
var Bo = Object.getOwnPropertyDescriptor, Po = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Bo(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, t9 = (e, t) => (n, r) => t(n, r, e);
let Xe = class extends v1 {
  constructor(t, n) {
    super();
    F(this, "_confirmOptions", []);
    F(this, "confirmOptions$", new X1([]));
  ...
  open(t) {
    return this._confirmOptions.find((n) => n.id === t.id) ? this._confirmOptions = this._confirmOptions.map((n) => ({
      ...
      ...t,
      visible: !0
    }), this.confirmOptions$.next(this._confirmOptions), h1(() => {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(c1.GLOBAL, () => $1(Ao, this._injector))
    );
  }
};
Xe = Po([
...
const ct = g1("univer.ui.dialog-service");
function Fo() {
  const e = k(ct), [t, n] = G([]);
  q(() => {
    const s = e.getDialogs$().subscribe((i) => {
      n(i);
    });
    return () => s.unsubscribe();
  }, []);
  const r = Q(() => t.map((o) => {
    const { children: s, title: i, footer: u, ...d } = o, v = d;
    for (const g of ["children", "title", "footer"]) {
      const c = g, m = o[c];
      m && (v[c] = /* @__PURE__ */ f(_1, { ...m }));
    }
    return v;
  }), [t]);
  return r == null ? void 0 : r.map((o) => /* @__PURE__ */ f(U2, { ...o }, o.id));
}
var ko = Object.getOwnPropertyDescriptor, jo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ko(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, n9 = (e, t) => (n, r) => t(n, r, e);
let qe = class extends v1 {
  constructor(t, n) {
    super();
    F(this, "_dialogOptions", []);
    F(this, "_dialogOptions$", new N1());
    this._injector = t, this._uiPartsService = n, this._initUIPart();
  }
  dispose() {
  ...
  open(t) {
    return this._dialogOptions.find((n) => n.id === t.id) ? this._dialogOptions = this._dialogOptions.map((n) => ({
      ...
      ...t,
      open: !0
    }), this._dialogOptions$.next(this._dialogOptions), h1(() => {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(c1.GLOBAL, () => $1(Fo, this._injector))
    );
  }
};
qe = jo([
...
const ut = g1("univer.ui.gallery-service");
function Uo() {
  const e = k(ut), t = d1(e.gallery$);
  return t ? /* @__PURE__ */ f(z2, { ...t }) : null;
}
var zo = Object.getOwnPropertyDescriptor, Wo = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? zo(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, r9 = (e, t) => (n, r) => t(n, r, e);
let Je = class extends v1 {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(c1.GLOBAL, () => $1(Uo, this._injector))
    );
  }
};
Je = Wo([
...
var Yo = Object.getOwnPropertyDescriptor, Go = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Yo(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, Xo = (e, t) => (n, r) => t(n, r, e);
let Qe = class {
  constructor(e) {
    F(this, "visible$", new N1());
    F(this, "componentKey$", new N1());
  ...
  set(e, t) {
    return this._componentManager.register(e, t), this.componentKey$.next(e), this._componentKey = e, h1(() => {
...
class lr extends v1 {
  openFile(t) {
    return new Promise((n) => {
      ...
      r.type = "file", r.accept = (o = t == null ? void 0 : t.accept) != null ? o : "", r.multiple = (s = t == null ? void 0 : t.multiple) != null ? s : !1, r.onchange = (i) => {
...
const ar = g1("univer-ui.local-file.service");
      ...
      return (function n(r, o, s) {
        function i(v, g) {
          if (!o[v]) {
            ...
            var L = o[v] = { exports: {} };
            r[v][0].call(L.exports, function(_) {
              var O = r[v][1][_];
              return i(O || _);
            }, L, L.exports, n, r, o, s);
          }
        ...
        for (var u = typeof $e == "function" && $e, d = 0; d < s.length; d++) i(s[d]);
        return i;
      })({ 1: [function(n, r, o) {
        (function(s) {
          var i = s.MutationObserver || s.WebKitMutationObserver, u;
          if (i) {
            var d = 0, v = new i(_), g = s.document.createTextNode("");
            v.observe(g, {
              characterData: !0
            }), u = function() {
              g.data = d = ++d % 2;
            ...
            c.port1.onmessage = _, u = function() {
            ...
            S.onreadystatechange = function() {
              _(), S.onreadystatechange = null, S.parentNode.removeChild(S), S = null;
        ...
        var u = {}, d = ["REJECTED"], v = ["FULFILLED"], g = ["PENDING"];
        r.exports = c;
        function c(w) {
          if (typeof w != "function")
            throw new TypeError("resolver must be a function");
          this.state = g, this.queue = [], this.outcome = void 0, w !== i && O(this, w);
        }
        c.prototype.catch = function(w) {
          return this.then(null, w);
        }, c.prototype.then = function(w, $) {
          if (typeof w != "function" && this.state === v || typeof $ != "function" && this.state === d)
            return this;
          var T = new this.constructor(i);
          if (this.state !== g) {
            var W = this.state === v ? w : $;
            L(T, W, this.outcome);
          } else
            this.queue.push(new m(T, w, $));
          return T;
        };
        function m(w, $, T) {
          this.promise = w, typeof $ == "function" && (this.onFulfilled = $, this.callFulfilled = this.otherCallFulfilled), typeof T == "function" && (this.onRejected = T, this.callRejected = this.otherCallRejected);
        }
        ...
        u.resolve = function(w, $) {
          ...
          if (W)
            ...
            w.state = v, w.outcome = $;
            for (var A = -1, U = w.queue.length; ++A < U; )
              w.queue[A].callFulfilled($);
          }
          return w;
        }, u.reject = function(w, $) {
          w.state = d, w.outcome = $;
          for (var T = -1, W = w.queue.length; ++T < W; )
            w.queue[T].callRejected($);
          return w;
        };
        function _(w) {
          var $ = w && w.then;
          if (w && (typeof w == "object" || typeof w == "function") && typeof $ == "function")
            return function() {
              $.apply(w, arguments);
            };
        }
        function O(w, $) {
          ...
          var Y = S(U);
          Y.status === "error" && W(Y.value);
        }
        function S(w, $) {
          var T = {};
          try {
            T.value = w($), T.status = "success";
          } catch (W) {
        ...
        function R(w) {
          ...
          if (!T)
            return this.resolve([]);
          for (var A = new Array(T), U = 0, Y = -1, X = new this(i); ++Y < T; )
            K(w[Y], Y);
          return X;
          function K(j, z) {
            $.resolve(j).then(e1, function(u1) {
              W || (W = !0, u.reject(X, u1));
            });
            function e1(u1) {
              A[z] = u1, ++U === T && !W && (W = !0, u.resolve(X, A));
            }
          }
        }
        c.race = B;
        function B(w) {
          ...
          if (!T)
            return this.resolve([]);
          for (var A = -1, U = new this(i); ++A < T; )
            Y(w[A]);
          return U;
          function Y(X) {
            $.resolve(X).then(function(K) {
              W || (W = !0, u.resolve(U, K));
            }, function(K) {
              W || (W = !0, u.reject(U, K));
            });
        ...
        function v() {
          try {
            if (!d || !d.open)
              return !1;
            var l = typeof openDatabase < "u" && /(Safari|iPhone|iPad|iPod)/.test(navigator.userAgent) && !/Chrome/.test(navigator.userAgent) && !/BlackBerry/.test(navigator.platform), h = typeof fetch == "function" && fetch.toString().indexOf("[native code") !== -1;
            return (!l || h) && typeof indexedDB < "u" && // some outdated implementations of IDB that appear on Samsung
        ...
        function g(l, h) {
          ...
          try {
            ...
            if (C.name !== "TypeError")
              throw C;
            for (var a = typeof BlobBuilder < "u" ? BlobBuilder : typeof MSBlobBuilder < "u" ? MSBlobBuilder : typeof MozBlobBuilder < "u" ? MozBlobBuilder : WebKitBlobBuilder, p = new a(), b = 0; b < l.length; b += 1)
              p.append(l[b]);
        ...
        function L(l, h, a) {
          typeof h == "function" && l.then(h), typeof a == "function" && l.catch(a);
        }
        function _(l) {
        ...
        var S = "local-forage-detect-blob-support", y = void 0, E = {}, R = Object.prototype.toString, B = "readonly", w = "readwrite";
        function $(l) {
          for (var h = l.length, a = new ArrayBuffer(h), p = new Uint8Array(a), b = 0; b < h; b++)
            p[b] = l.charCodeAt(b);
          return a;
        }
        function T(l) {
          return new c(function(h) {
            var a = l.transaction(S, w), p = g([""]);
            a.objectStore(S).put(p, "key"), a.onabort = function(b) {
              b.preventDefault(), b.stopPropagation(), h(!1);
            }, a.oncomplete = function() {
              var b = navigator.userAgent.match(/Chrome\/(\d+)/), C = navigator.userAgent.match(/Edge\//);
              h(C || !b || parseInt(b[1], 10) >= 43);
            };
          }).catch(function() {
            return !1;
          });
        ...
        function W(l) {
          return typeof y == "boolean" ? c.resolve(y) : T(l).then(function(h) {
            return y = h, y;
          });
        }
        function A(l) {
          var h = E[l.name], a = {};
          a.promise = new c(function(p, b) {
            a.resolve = p, a.reject = b;
          }), h.deferredOperations.push(a), h.dbReady ? h.dbReady = h.dbReady.then(function() {
            return a.promise;
          }) : h.dbReady = a.promise;
        }
        function U(l) {
          var h = E[l.name], a = h.deferredOperations.pop();
          if (a)
            return a.resolve(), a.promise;
        }
        function Y(l, h) {
          var a = E[l.name], p = a.deferredOperations.pop();
          if (p)
            return p.reject(h), p.promise;
        }
        function X(l, h) {
          return new c(function(a, p) {
            if (E[l.name] = E[l.name] || s1(), l.db)
              if (h)
                A(l), l.db.close();
              else
                return a(l.db);
            ...
            h && (C.onupgradeneeded = function(x) {
              var V = C.result;
              try {
                V.createObjectStore(l.storeName), x.oldVersion <= 1 && V.createObjectStore(S);
              } catch (N) {
                if (N.name === "ConstraintError")
                  console.warn('The database "' + l.name + '" has been upgraded from version ' + x.oldVersion + " to version " + x.newVersion + ', but the storage "' + l.storeName + '" already exists.');
                else
                  throw N;
              }
            }), C.onerror = function(x) {
              x.preventDefault(), p(C.error);
            }, C.onsuccess = function() {
              var x = C.result;
              x.onversionchange = function(V) {
                V.target.close();
              }, a(x), U(l);
            };
          });
        ...
        function z(l, h) {
          if (!l.db)
            return !0;
          var a = !l.db.objectStoreNames.contains(l.storeName), p = l.version < l.db.version, b = l.version > l.db.version;
          if (p && (l.version !== h && console.warn('The database "' + l.name + `" can't be downgraded from version ` + l.db.version + " to version " + l.version + "."), l.version = l.db.version), b || a) {
            if (a) {
        ...
        function e1(l) {
          return new c(function(h, a) {
            ...
            p.onerror = a, p.onloadend = function(b) {
        ...
        function O1(l) {
          A(l);
          for (var h = E[l.name], a = h.forages, p = 0; p < a.length; p++) {
            var b = a[p];
            b._dbInfo.db && (b._dbInfo.db.close(), b._dbInfo.db = null);
          }
          return l.db = null, K(l).then(function(C) {
            return l.db = C, z(l) ? j(l) : C;
          }).then(function(C) {
            l.db = h.db = C;
        ...
        function l1(l, h, a, p) {
          p === void 0 && (p = 1);
          try {
            var b = l.db.transaction(l.storeName, h);
            a(null, b);
          } catch (C) {
            if (p > 0 && (!l.db || C.name === "InvalidStateError" || C.name === "NotFoundError"))
              return c.resolve().then(function() {
                if (!l.db || C.name === "NotFoundError" && !l.db.objectStoreNames.contains(l.storeName) && l.version <= l.db.version)
                  return l.db && (l.version = l.db.version + 1), j(l);
              }).then(function() {
                return O1(l).then(function() {
                  l1(l, h, a, p - 1);
                });
              }).catch(a);
            a(C);
        ...
        function p1(l) {
          ...
          if (l)
            for (var p in l)
              a[p] = l[p];
          var b = E[a.name];
          b || (b = s1(), E[a.name] = b), b.forages.push(h), h._initReady || (h._initReady = h.ready, h.ready = y1);
          var C = [];
          function x() {
            return c.resolve();
          }
          for (var V = 0; V < b.forages.length; V++) {
            var N = b.forages[V];
            N !== h && C.push(N._initReady().catch(x));
          }
          var D = b.forages.slice(0);
          return c.all(C).then(function() {
            return a.db = b.db, K(a);
          }).then(function(Z) {
            return a.db = Z, z(a, h._defaultConfig.version) ? j(a) : Z;
          }).then(function(Z) {
            a.db = b.db = Z, h._dbInfo = a;
            for (var P = 0; P < D.length; P++) {
              var J = D[P];
              J !== h && (J._dbInfo.db = a.db, J._dbInfo.version = a.version);
            }
          });
        }
        function R1(l, h) {
          var a = this;
          l = _(l);
          var p = new c(function(b, C) {
            a.ready().then(function() {
              l1(a._dbInfo, B, function(x, V) {
                if (x)
                  return C(x);
                try {
                  var N = V.objectStore(a._dbInfo.storeName), D = N.get(l);
                  D.onsuccess = function() {
                    var Z = D.result;
                    Z === void 0 && (Z = null), b1(Z) && (Z = u1(Z)), b(Z);
                  }, D.onerror = function() {
                    C(D.error);
                  };
                } catch (Z) {
        ...
        function T1(l, h) {
          var a = this, p = new c(function(b, C) {
            a.ready().then(function() {
              l1(a._dbInfo, B, function(x, V) {
                if (x)
                  return C(x);
                try {
                  var N = V.objectStore(a._dbInfo.storeName), D = N.openCursor(), Z = 1;
                  D.onsuccess = function() {
                    var P = D.result;
                    if (P) {
                      var J = P.value;
        ...
        function z1(l, h, a) {
          var p = this;
          l = _(l);
          var b = new c(function(C, x) {
            var V;
            p.ready().then(function() {
              return V = p._dbInfo, R.call(h) === "[object Blob]" ? W(V.db).then(function(N) {
                return N ? h : e1(h);
              }) : h;
            }).then(function(N) {
              l1(p._dbInfo, w, function(D, Z) {
                if (D)
                  return x(D);
                try {
                  ...
                  Z.oncomplete = function() {
                    ...
                    var o1 = J.error ? J.error : J.transaction.error;
                    x(o1);
                  };
                } catch (o1) {
                  x(o1);
        ...
        function J1(l, h) {
          ...
          var p = new c(function(b, C) {
            a.ready().then(function() {
              l1(a._dbInfo, w, function(x, V) {
                if (x)
                  return C(x);
                try {
                  var N = V.objectStore(a._dbInfo.storeName), D = N.delete(l);
                  V.oncomplete = function() {
                    b();
                  }, V.onerror = function() {
                    C(D.error);
                  }, V.onabort = function() {
                    var Z = D.error ? D.error : D.transaction.error;
                    C(Z);
                  };
                } catch (Z) {
                  C(Z);
        ...
        function Q1(l) {
          var h = this, a = new c(function(p, b) {
            h.ready().then(function() {
              l1(h._dbInfo, w, function(C, x) {
                if (C)
                  return b(C);
                try {
                  var V = x.objectStore(h._dbInfo.storeName), N = V.clear();
                  x.oncomplete = function() {
                    p();
                  }, x.onabort = x.onerror = function() {
                    var D = N.error ? N.error : N.transaction.error;
                    b(D);
                  };
                } catch (D) {
                  b(D);
        ...
        function hr(l) {
          var h = this, a = new c(function(p, b) {
            h.ready().then(function() {
              l1(h._dbInfo, B, function(C, x) {
                if (C)
                  return b(C);
                try {
                  var V = x.objectStore(h._dbInfo.storeName), N = V.count();
            ...
            a.ready().then(function() {
              l1(a._dbInfo, B, function(x, V) {
                if (x)
                  return C(x);
                try {
                  var N = V.objectStore(a._dbInfo.storeName), D = !1, Z = N.openKeyCursor();
            ...
            h.ready().then(function() {
              l1(h._dbInfo, B, function(C, x) {
                if (C)
                  return b(C);
                try {
                  var V = x.objectStore(h._dbInfo.storeName), N = V.openKeyCursor(), D = [];
                  N.onsuccess = function() {
                    var Z = N.result;
                    if (!Z) {
                      p(D);
        ...
        function vr(l, h) {
          ...
          var a = this.config();
          l = typeof l != "function" && l || {}, l.name || (l.name = l.name || a.name, l.storeName = l.storeName || a.storeName);
          var p = this, b;
          if (!l.name)
            b = c.reject("Invalid arguments");
          else {
            var C = l.name === a.name && p._dbInfo.db, x = C ? c.resolve(p._dbInfo.db) : K(l).then(function(V) {
              var N = E[l.name], D = N.forages;
              N.db = V;
              for (var Z = 0; Z < D.length; Z++)
                D[Z]._dbInfo.db = V;
              return V;
            });
            l.storeName ? b = x.then(function(V) {
              if (V.objectStoreNames.contains(l.storeName)) {
                var N = V.version + 1;
                A(l);
                var D = E[l.name], Z = D.forages;
                V.close();
                for (var P = 0; P < Z.length; P++) {
                  var J = Z[P];
                  J._dbInfo.db = null, J._dbInfo.version = N;
                }
                var o1 = new c(function(i1, C1) {
                  var f1 = d.open(l.name, N);
                  f1.onerror = function(E1) {
                    var de = f1.result;
                    de.close(), C1(E1);
                  }, f1.onupgradeneeded = function() {
                    var E1 = f1.result;
                    E1.deleteObjectStore(l.storeName);
                  }, f1.onsuccess = function() {
                    var E1 = f1.result;
                    E1.close(), i1(E1);
                  };
                });
                return o1.then(function(i1) {
                  D.db = i1;
                  for (var C1 = 0; C1 < Z.length; C1++) {
                    var f1 = Z[C1];
                    f1._dbInfo.db = i1, U(f1._dbInfo);
                  }
                }).catch(function(i1) {
                  throw (Y(l, i1) || c.resolve()).catch(function() {
                  }), i1;
                });
              }
            }) : b = x.then(function(V) {
              ...
              var J = new c(function(o1, i1) {
                var C1 = d.deleteDatabase(l.name);
                C1.onerror = function() {
                  var f1 = C1.result;
                  f1 && f1.close(), i1(C1.error);
                }, C1.onblocked = function() {
              ...
              return J.then(function(o1) {
                ...
                throw (Y(l, o1) || c.resolve()).catch(function() {
                }), o1;
              });
            });
          }
        ...
        var P1 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", mr = "~~local_forage_type~", ht = /^~~local_forage_type~([^~]+)~/, Me = "__lfsc__:", d3 = Me.length, h3 = "arbf", f3 = "blob", ft = "si08", Ct = "ui08", vt = "uic8", gt = "si16", pt = "si32", mt = "ur16", bt = "ui32", Lt = "fl32", wt = "fl64", _t = d3 + h3.length, yt = Object.prototype.toString;
        function Mt(l) {
          var h = l.length * 0.75, a = l.length, p, b = 0, C, x, V, N;
          l[l.length - 1] === "=" && (h--, l[l.length - 2] === "=" && h--);
          var D = new ArrayBuffer(h), Z = new Uint8Array(D);
          for (p = 0; p < a; p += 4)
            C = P1.indexOf(l[p]), x = P1.indexOf(l[p + 1]), V = P1.indexOf(l[p + 2]), N = P1.indexOf(l[p + 3]), Z[b++] = C << 2 | x >> 4, Z[b++] = (x & 15) << 4 | V >> 2, Z[b++] = (V & 3) << 6 | N & 63;
          return D;
        }
        function C3(l) {
          var h = new Uint8Array(l), a = "", p;
          for (p = 0; p < h.length; p += 3)
            a += P1[h[p] >> 2], a += P1[(h[p] & 3) << 4 | h[p + 1] >> 4], a += P1[(h[p + 1] & 15) << 2 | h[p + 2] >> 6], a += P1[h[p + 2] & 63];
          return h.length % 3 === 2 ? a = a.substring(0, a.length - 1) + "=" : h.length % 3 === 1 && (a = a.substring(0, a.length - 2) + "=="), a;
        }
        function br(l, h) {
          var a = "";
          if (l && (a = yt.call(l)), l && (a === "[object ArrayBuffer]" || l.buffer && yt.call(l.buffer) === "[object ArrayBuffer]")) {
            var p, b = Me;
            l instanceof ArrayBuffer ? (p = l, b += h3) : (p = l.buffer, a === "[object Int8Array]" ? b += ft : a === "[object Uint8Array]" ? b += Ct : a === "[object Uint8ClampedArray]" ? b += vt : a === "[object Int16Array]" ? b += gt : a === "[object Uint16Array]" ? b += mt : a === "[object Int32Array]" ? b += pt : a === "[object Uint32Array]" ? b += bt : a === "[object Float32Array]" ? b += Lt : a === "[object Float64Array]" ? b += wt : h(new Error("Failed to get type for BinaryArray"))), h(b + C3(p));
          } else if (a === "[object Blob]") {
            var C = new FileReader();
            C.onload = function() {
              var x = mr + l.type + "~" + C3(this.result);
              h(Me + f3 + x);
            ...
            try {
              ...
              console.error("Couldn't convert value into a JSON string: ", l), h(null, x);
            }
        }
        function Lr(l) {
          if (l.substring(0, d3) !== Me)
            return JSON.parse(l);
          var h = l.substring(_t), a = l.substring(d3, _t), p;
          if (a === f3 && ht.test(h)) {
            var b = h.match(ht);
            p = b[1], h = h.substring(b[0].length);
          }
          var C = Mt(h);
          switch (a) {
            case h3:
        ...
        function It(l, h, a, p) {
          l.executeSql("CREATE TABLE IF NOT EXISTS " + h.storeName + " (id INTEGER PRIMARY KEY, key unique, value)", [], a, p);
        }
        function wr(l) {
          var h = this, a = {
            db: null
          ...
          if (l)
            for (var p in l)
              a[p] = typeof l[p] != "string" ? l[p].toString() : l[p];
          var b = new c(function(C, x) {
            try {
          ...
          return a.serializer = v3, b;
        }
        function F1(l, h, a, p, b, C) {
          l.executeSql(a, p, b, function(x, V) {
            V.code === V.SYNTAX_ERR ? x.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [h.storeName], function(N, D) {
              D.rows.length ? C(N, V) : It(N, h, function() {
                N.executeSql(a, p, b, C);
              }, C);
            }, C) : C(x, V);
          }, C);
        }
        function _r(l, h) {
          ...
          var p = new c(function(b, C) {
            a.ready().then(function() {
              var x = a._dbInfo;
              x.db.transaction(function(V) {
                F1(V, x, "SELECT * FROM " + x.storeName + " WHERE key = ? LIMIT 1", [l], function(N, D) {
                  var Z = D.rows.length ? D.rows.item(0).value : null;
                  Z && (Z = x.serializer.deserialize(Z)), b(Z);
                }, function(N, D) {
                  C(D);
                });
              });
        ...
        function yr(l, h) {
          var a = this, p = new c(function(b, C) {
            a.ready().then(function() {
              var x = a._dbInfo;
              x.db.transaction(function(V) {
                F1(V, x, "SELECT * FROM " + x.storeName, [], function(N, D) {
                  for (var Z = D.rows, P = Z.length, J = 0; J < P; J++) {
                    var o1 = Z.item(J), i1 = o1.value;
                    if (i1 && (i1 = x.serializer.deserialize(i1)), i1 = l(i1, o1.key, J + 1), i1 !== void 0) {
                      b(i1);
                      return;
                    }
                  }
        ...
        function Ht(l, h, a, p) {
          var b = this;
          l = _(l);
          var C = new c(function(x, V) {
            b.ready().then(function() {
              h === void 0 && (h = null);
              var N = h, D = b._dbInfo;
              D.serializer.serialize(h, function(Z, P) {
                P ? V(P) : D.db.transaction(function(J) {
                  F1(J, D, "INSERT OR REPLACE INTO " + D.storeName + " (key, value) VALUES (?, ?)", [l, Z], function() {
                    x(N);
                  }, function(o1, i1) {
                    V(i1);
                  });
        ...
        function Ir(l, h) {
          ...
          var p = new c(function(b, C) {
            a.ready().then(function() {
              var x = a._dbInfo;
              x.db.transaction(function(V) {
                F1(V, x, "DELETE FROM " + x.storeName + " WHERE key = ?", [l], function() {
                  b();
                }, function(N, D) {
                  C(D);
                });
        ...
        function Hr(l) {
          var h = this, a = new c(function(p, b) {
            h.ready().then(function() {
              var C = h._dbInfo;
              C.db.transaction(function(x) {
                F1(x, C, "DELETE FROM " + C.storeName, [], function() {
                  p();
                }, function(V, N) {
                  b(N);
                });
        ...
        function xr(l) {
          var h = this, a = new c(function(p, b) {
            h.ready().then(function() {
              var C = h._dbInfo;
              C.db.transaction(function(x) {
                F1(x, C, "SELECT COUNT(key) as c FROM " + C.storeName, [], function(V, N) {
                  var D = N.rows.item(0).c;
                  p(D);
                }, function(V, N) {
                  b(N);
                });
        ...
        function Sr(l, h) {
          var a = this, p = new c(function(b, C) {
            a.ready().then(function() {
              var x = a._dbInfo;
              x.db.transaction(function(V) {
                F1(V, x, "SELECT key FROM " + x.storeName + " WHERE id = ? LIMIT 1", [l + 1], function(N, D) {
                  var Z = D.rows.length ? D.rows.item(0).key : null;
                  b(Z);
                }, function(N, D) {
                  C(D);
                });
        ...
        function Rr(l) {
          var h = this, a = new c(function(p, b) {
            h.ready().then(function() {
              var C = h._dbInfo;
              C.db.transaction(function(x) {
                F1(x, C, "SELECT key FROM " + C.storeName, [], function(V, N) {
                  for (var D = [], Z = 0; Z < N.rows.length; Z++)
                    D.push(N.rows.item(Z).key);
                  p(D);
                }, function(V, N) {
                  b(N);
                });
          ...
          return new c(function(h, a) {
            l.transaction(function(p) {
              p.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name <> '__WebKitDatabaseInfoTable__'", [], function(b, C) {
                for (var x = [], V = 0; V < C.rows.length; V++)
                  x.push(C.rows.item(V).name);
                h({
                  db: l,
                  storeNames: x
                });
        ...
        function Or(l, h) {
          ...
          l = typeof l != "function" && l || {}, l.name || (l.name = l.name || a.name, l.storeName = l.storeName || a.storeName);
          var p = this, b;
          return l.name ? b = new c(function(C) {
            var x;
            l.name === a.name ? x = p._dbInfo.db : x = openDatabase(l.name, "", "", 0), l.storeName ? C({
              db: x,
              storeNames: [l.storeName]
            }) : C(Vr(x));
          }).then(function(C) {
            return new c(function(x, V) {
              C.db.transaction(function(N) {
                function D(o1) {
                  return new c(function(i1, C1) {
                    N.executeSql("DROP TABLE IF EXISTS " + o1, [], function() {
                      i1();
                    }, function(f1, E1) {
                      C1(E1);
                    });
                ...
                for (var Z = [], P = 0, J = C.storeNames.length; P < J; P++)
                  Z.push(D(C.storeNames[P]));
                c.all(Z).then(function() {
                  x();
                }).catch(function(o1) {
                  V(o1);
                });
          ...
          }) : b = c.reject("Invalid arguments"), m(b, h), b;
        }
        var Er = {
        ...
        function xt(l, h) {
          var a = l.name + "/";
          return l.storeName !== h.storeName && (a += l.storeName + "/"), a;
        }
        function Nr() {
        ...
        function Tr(l) {
          ...
          if (l)
            for (var p in l)
              a[p] = l[p];
          return a.keyPrefix = xt(l, h._defaultConfig), Dr() ? (h._dbInfo = a, a.serializer = v3, c.resolve()) : c.reject();
        }
        function Zr(l) {
          var h = this, a = h.ready().then(function() {
            for (var p = h._dbInfo.keyPrefix, b = localStorage.length - 1; b >= 0; b--) {
        ...
        function Ar(l, h) {
          ...
          var p = a.ready().then(function() {
            var b = a._dbInfo, C = localStorage.getItem(b.keyPrefix + l);
        ...
        function Br(l, h) {
          var a = this, p = a.ready().then(function() {
            for (var b = a._dbInfo, C = b.keyPrefix, x = C.length, V = localStorage.length, N = 1, D = 0; D < V; D++) {
              var Z = localStorage.key(D);
              if (Z.indexOf(C) === 0) {
                var P = localStorage.getItem(Z);
                if (P && (P = b.serializer.deserialize(P)), P = l(P, Z.substring(x), N++), P !== void 0)
                  return P;
              }
            }
          });
        ...
        function Fr(l) {
          var h = this, a = h.ready().then(function() {
            for (var p = h._dbInfo, b = localStorage.length, C = [], x = 0; x < b; x++) {
              var V = localStorage.key(x);
              V.indexOf(p.keyPrefix) === 0 && C.push(V.substring(p.keyPrefix.length));
            }
            return C;
          });
          return m(a, l), a;
        ...
        function Ur(l, h, a) {
          ...
          var b = p.ready().then(function() {
            ...
            return new c(function(x, V) {
              var N = p._dbInfo;
              N.serializer.serialize(h, function(D, Z) {
                if (Z)
                  V(Z);
                else
                  try {
                    localStorage.setItem(N.keyPrefix + l, D), x(C);
                  } catch (P) {
                    (P.name === "QuotaExceededError" || P.name === "NS_ERROR_DOM_QUOTA_REACHED") && V(P), V(P);
                  }
              });
            });
          });
        ...
        function zr(l, h) {
          if (h = O.apply(this, arguments), l = typeof l != "function" && l || {}, !l.name) {
            var a = this.config();
            l.name = l.name || a.name, l.storeName = l.storeName || a.storeName;
          }
          var p = this, b;
          return l.name ? b = new c(function(C) {
            l.storeName ? C(xt(l, p._defaultConfig)) : C(l.name + "/");
          }).then(function(C) {
            for (var x = localStorage.length - 1; x >= 0; x--) {
              var V = localStorage.key(x);
              V.indexOf(C) === 0 && localStorage.removeItem(V);
            }
          }) : b = c.reject("Invalid arguments"), m(b, h), b;
        }
        var Wr = {
          ...
          WEBSQL: Er,
          LOCALSTORAGE: Wr
        }, Xr = [K1.INDEXEDDB._driver, K1.WEBSQL._driver, K1.LOCALSTORAGE._driver], Ie = ["dropInstance"], g3 = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"].concat(Ie), qr = {
          description: "",
          driver: Xr.slice(),
          name: "localforage",
        ...
        function p3() {
          for (var l = 1; l < arguments.length; l++) {
            ...
            if (h)
              for (var a in h)
                h.hasOwnProperty(a) && (St(h[a]) ? arguments[0][a] = h[a].slice() : arguments[0][a] = h[a]);
          }
          return arguments[0];
        }
        var Qr = (function() {
          function l(h) {
            i(this, l);
            for (var a in K1)
              if (K1.hasOwnProperty(a)) {
                var p = K1[a], b = p._driver;
                this[a] = b, ue[b] || this.defineDriver(p);
              }
            this._defaultConfig = p3({}, qr), this._config = p3({}, this._defaultConfig, h), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch(function() {
            });
          }
          return l.prototype.config = function(a) {
          ...
          }, l.prototype.defineDriver = function(a, p, b) {
            var C = new c(function(x, V) {
              try {
                var N = a._driver, D = new Error("Custom driver not compliant; see https://mozilla.github.io/localForage/#definedriver");
                if (!a._driver) {
                  V(D);
                  return;
                }
                for (var Z = g3.concat("_initStorage"), P = 0, J = Z.length; P < J; P++) {
                  var o1 = Z[P], i1 = !Gr(Ie, o1);
                  if ((i1 || a[o1]) && typeof a[o1] != "function") {
                    V(D);
                    return;
                  }
                }
                var C1 = function() {
                  for (var de = function(t2) {
                    return function() {
                      var n2 = new Error("Method " + t2 + " is not implemented by the current driver"), Vt = c.reject(n2);
                      return m(Vt, arguments[arguments.length - 1]), Vt;
                    };
                  }, m3 = 0, e2 = Ie.length; m3 < e2; m3++) {
                    var b3 = Ie[m3];
                    a[b3] || (a[b3] = de(b3));
                  }
                };
                C1();
                var f1 = function(de) {
                  ue[N] && console.info("Redefining LocalForage driver: " + N), ue[N] = a, Rt[N] = de, x();
                };
                "_support" in a ? a._support && typeof a._support == "function" ? a._support().then(f1, V) : f1(!!a._support) : f1(!0);
              } catch (E1) {
                V(E1);
              }
            });
          ...
          }, l.prototype.getDriver = function(a, p, b) {
            var C = ue[a] ? c.resolve(ue[a]) : c.reject(new Error("Driver not found."));
            return L(C, p, b), C;
          }, l.prototype.getSerializer = function(a) {
            var p = c.resolve(v3);
            return L(p, a), p;
          }, l.prototype.ready = function(a) {
            var p = this, b = p._driverSet.then(function() {
              return p._ready === null && (p._ready = p._initDriver()), p._ready;
            });
            return L(b, a, a), b;
          }, l.prototype.setDriver = function(a, p, b) {
            var C = this;
            St(a) || (a = [a]);
            ...
            function N(P) {
              return C._extend(P), V(), C._ready = C._initStorage(C._config), C._ready;
            }
            function D(P) {
              return function() {
                var J = 0;
                function o1() {
                  for (; J < P.length; ) {
                    var i1 = P[J];
                    return J++, C._dbInfo = null, C._ready = null, C.getDriver(i1).then(N).catch(o1);
                  }
                  V();
                  var C1 = new Error("No available storage method found.");
                  return C._driverSet = c.reject(C1), C._driverSet;
                }
                return o1();
              };
            }
            ...
            return this._driverSet = Z.then(function() {
              ...
              return C._dbInfo = null, C._ready = null, C.getDriver(P).then(function(J) {
                C._driver = J._driver, V(), C._wrapLibraryMethodsWithReady(), C._initDriver = D(x);
              });
            }).catch(function() {
              V();
              var P = new Error("No available storage method found.");
              return C._driverSet = c.reject(P), C._driverSet;
            }), L(this._driverSet, p, b), this._driverSet;
          }, l.prototype.supports = function(a) {
            return !!Rt[a];
          }, l.prototype._extend = function(a) {
            p3(this, a);
          }, l.prototype._getSupportedDrivers = function(a) {
            for (var p = [], b = 0, C = a.length; b < C; b++) {
              var x = a[b];
              this.supports(x) && p.push(x);
            }
            return p;
          }, l.prototype._wrapLibraryMethodsWithReady = function() {
            for (var a = 0, p = g3.length; a < p; a++)
              Jr(this, g3[a]);
          }, l.prototype.createInstance = function(a) {
            return new l(a);
          }, l;
        })(), Kr = new Qr();
        r.exports = Kr;
...
var Qo = Jo();
const W1 = /* @__PURE__ */ qo(Qo);
class cr {
  getItem(t) {
    return W1.getItem(t);
  }
  setItem(t, n) {
    return W1.setItem(t, n);
  }
  removeItem(t) {
    return W1.removeItem(t);
  }
  clear() {
    return W1.clear();
  }
...
var Ko = Object.getOwnPropertyDescriptor, ei = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? Ko(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, i9 = (e, t) => (n, r) => t(n, r, e);
let Ke = class extends v1 {
  constructor(e, t) {
    super(), this._injector = e, this._uiPartsService = t, this._initUIPart();
  }
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(c1.GLOBAL, () => $1(W2, this._injector))
    );
  }
  dispose() {
    He();
  ...
  show(e) {
    let t = e;
    return typeof e.id > "u" && (t = Object.assign({}, e, { id: `message-${Date.now()}` })), Y2(t), h1(() => He(t.id));
  }
  remove(e) {
    He(e);
  }
...
function ti() {
  const e = k(Y3), t = d1(e.darkMode$);
  return /* @__PURE__ */ f(X2, { theme: t ? "dark" : "light" });
}
const ni = {
  show: (e) => {
    const {
...
var ri = Object.getOwnPropertyDescriptor, oi = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ri(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, s9 = (e, t) => (n, r) => t(n, r, e);
let e3 = class extends v1 {
  constructor(e, t) {
    super(), this._injector = e, this._uiPartsService = t, this._initUIPart();
  }
  show(e) {
  ...
  _initUIPart() {
    this.disposeWithMe(
      this._uiPartsService.registerComponent(c1.GLOBAL, () => $1(ti, this._injector))
    );
  }
};
e3 = oi([
...
class ur {
  constructor() {
    ...
    F(this, "sidebarOptions$", new N1());
    F(this, "scrollEvent$", new N1());
    F(this, "_container");
  }
  get visible() {
  ...
  open(t) {
    return this._sidebarOptions = {
      ...
      id: t.id,
      visible: !0
    }, this.sidebarOptions$.next(this._sidebarOptions), h1(() => {
      this.close();
    });
  }
  close(t) {
...
var ii = Object.getOwnPropertyDescriptor, si = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ii(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, li = (e, t) => (n, r) => t(n, r, e);
let t3 = class {
  constructor(e) {
    F(this, "visible$", new X1(!1));
    F(this, "componentKey$", new I2());
    F(this, "_temporaryHidden$", new X1(!1));
  ...
  set(e, t) {
    return this._componentManager.register(e, t), this.componentKey$.next(e), h1(() => {
      this._componentManager.delete(e), this.visible$.complete(), this.componentKey$.complete();
    });
  }
  open() {
...
var ai = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, ui = (e, t, n) => t in e ? ai(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, di = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? ci(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, R3 = (e, t) => (n, r) => t(n, r, e), hi = (e, t, n) => ui(e, t + "", n);
const fi = "UNIVER_MOBILE_UI_PLUGIN", Ci = "DISABLE_AUTO_FOCUS";
let F3 = class extends g9 {
  constructor(e = Ue, t, n, r) {
    super(), this._config = e, this._contextService = t, this._injector = n, this._configService = r;
    const { menu: o, ...s } = Ae(
      {
        popupRootId: `univer-popup-portal-${ge(6)}`
      },
      Ue,
      this._config
    );
    s.disableAutoFocus && this._contextService.setContextValue(Ci, !0), o && this._configService.setConfig("menu", o, { merge: !0 }), this._configService.setConfig(_e, s);
  }
  onStarting() {
    p9(this._injector, m9([
      [S1],
      [a3],
      [Pe],
      [G3],
      ...
      [B1, { useClass: je }],
      [c3, { useClass: er }],
      [sr, { useClass: Ge, lazy: !0 }],
      [u3, { useClass: e3, lazy: !0 }],
      [ut, { useClass: Je, lazy: !0 }],
      [ct, { useClass: qe, lazy: !0 }],
      [at, { useClass: Xe, lazy: !0 }],
      [we, { useClass: ur, lazy: !0 }],
      [lt, { useClass: t3, lazy: !0 }],
      [st, { useClass: Qe, lazy: !0 }],
      [et, { useClass: Ke, lazy: !0 }],
      [b9, { useClass: cr, lazy: !0 }],
      [ir, { useClass: Ye }],
      [ar, { useClass: lr }],
      [rt, { useClass: Xn }],
      [nt],
...
var vi = Object.defineProperty, gi = Object.getOwnPropertyDescriptor, pi = (e, t, n) => t in e ? vi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, mi = (e, t, n, r) => {
  for (var o = r > 1 ? void 0 : r ? gi(t, n) : t, s = e.length - 1, i; s >= 0; s--)
    (i = e[s]) && (o = i(o) || o);
  return o;
}, V3 = (e, t) => (n, r) => t(n, r, e), bi = (e, t, n) => pi(e, t + "", n);
const Li = "UNIVER_UI_PLUGIN", wi = "DISABLE_AUTO_FOCUS";
let k3 = class extends g9 {
  constructor(e = Ue, t, n, r) {
    super(), this._config = e, this._contextService = t, this._injector = n, this._configService = r;
    const { menu: o, ...s } = Ae(
      {
    ...
    s.disableAutoFocus && this._contextService.setContextValue(wi, !0), o && this._configService.setConfig("menu", o, { merge: !0 }), this._configService.setConfig(_e, s);
  }
  onStarting() {
    p9(this._injector, m9([
      [S1],
...
const _i = 0.75, l9 = 78, a9 = 9, yi = "rgba(0,0,0,0)", Mi = "rgb(0,0,0)";
function dr(e) {
  var u;
  let t = e.childNodes;
  if (t.length === 0)
  ...
  const n = [];
  let r = 0, o = 0, s = e.textContent || "";
  s += `\r
`;
  for (let d = 0; d < t.length; d++) {
    let v = t[`${d}`], g;
    v.nodeName === "#text" ? (g = (u = v.textContent) != null ? u : "", v = v.parentElement) : g = v.innerText;
    const c = dt(v);
    Ii(g).forEach((L) => {
      const _ = L.length;
      o += _, r = o - _;
...
function dt(e, t = "") {
  ...
  return r.forEach((d) => {
    var m;
    const v = d.toLowerCase(), g = O3(v.substr(0, v.indexOf(":"))), c = O3(v.substr(v.indexOf(":") + 1));
    if (g === "font-weight")
      ...
      n.indexOf("vertical-align") > -1 && (n.indexOf("sub") > -1 || n.indexOf("sup") > -1) && (L *= 2), c.indexOf("px") !== -1 && (L = xi(Number.parseInt(c, 10))), o.fs = L;
    } else if (g === "color") {
      const L = new E3(c);
      o.cl = {
      ...
      const L = (m = c.split(" ")) == null ? void 0 : m[0];
    ...
    if (g === "univer-underline" && (o.ul = {
      s: 1
    }), g === "vertical-align" && (c === "sub" ? o.va = y3.SUBSCRIPT : c === "super" ? o.va = y3.SUPERSCRIPT : c === "top" ? o.vt = 1 : c === "middle" ? o.vt = 2 : c === "bottom" ? o.vt = 3 : o.va = y3.NORMAL), g === "transform") {
      const L = c.split(")"), _ = L.findIndex((O) => O.includes("rotate"));
      if (_ > -1) {
        const O = L[_].match(/\d+/g);
        let S = 0, y = 0;
        O != null && O.length && (S = +O[0]), e != null && e.dataset.vertical && (y = +e.dataset.vertical), o.tr = {
          a: S,
          v: y
        };
      }
    ...
    if (g === "border-width" || g === "border-style") {
      ...
      for (const _ in L)
        s[_] += ` ${L[_]}`;
      o.bd ? (o.bd.b.s = Z1(s.b), o.bd.t.s = Z1(s.t), o.bd.l.s = Z1(s.l), o.bd.r.s = Z1(s.r)) : o.bd = {
        b: {
          cl: {
            rgb: "#000"
          },
    ...
    if (g === "border-bottom" || g === "border-top" || g === "border-left" || g === "border-right" || g === "border") {
      ...
      if (Z1(_) !== m2.NONE && O) {
        ...
        g === "border-bottom" ? o.bd.b = c === "none" ? null : y : g === "border-top" ? o.bd.t = c === "none" ? null : y : g === "border-left" ? o.bd.l = c === "none" ? null : y : g === "border-right" ? o.bd.r = c === "none" ? null : y : g === "border" && (o.bd = {
          r: c === "none" ? null : y,
          t: c === "none" ? null : y,
          b: c === "none" ? null : y,
          l: c === "none" ? null : y
      ...
      const L = /[+-]?\d+/, _ = c.match(L);
      c === "(0deg ,1)" ? o.tr = { a: 0, v: 1 } : _ && (o.tr = { a: Number(_[0]) });
    }
...
function s7(e) {
  ...
  for (let o = 0; o < r.length; o++) {
    const s = r[o], i = s.getAttribute("span");
    if (i && +i > 1)
      for (let u = 0; u < +i; u++) {
        const d = n3(s.getAttribute("width"), 72);
        n.push(d);
      }
    else {
      const u = n3(s.getAttribute("width"), 72);
      n.push(u);
    }
  }
  return n;
...
function n3(e, t) {
  if (!e) return t;
  let n;
  return e.includes("pt") ? n = q2(Number.parseFloat(e)) : e.includes("px") ? n = Number.parseFloat(e) : n = Number.parseFloat(e) * 72 / 96, n;
}
function l7(e) {
  const t = document.createElement("DIV"), n = [];
  t.innerHTML = e;
  ...
  for (let o = 0; o < r.length; o++) {
    ...
    for (let d = 0; d < i.length; d++) {
      const v = i[d].getAttribute("rowSpan");
      if (!(v && +v > 1)) {
...
function a7(e) {
  ...
  o[0].querySelectorAll("td").forEach((u) => {
    let d = 0;
    const v = u.getAttribute("colSpan");
    v !== null ? d = +v : d = 1, r += d;
  });
  ...
  return o.forEach((u) => {
    let d = 0;
    u.querySelectorAll("td").forEach((v) => {
      var L, _;
      const g = {};
      if (v.querySelectorAll("span").length || v.querySelectorAll("font").length) {
        const O = dr(v);
        typeof O != "string" && (g.p = O);
      }
      const c = v.innerText;
      c.trim().length === 0 ? g.v = "" : g.v = c;
      const m = dt(v);
      for (L9.isPlainObject(m) && (g.s = m); d < r && t[i][d] != null; )
        d++;
      if (d !== r) {
        if (t[i][d] == null) {
          t[i][d] = g;
          const O = (L = Number(v.getAttribute("rowSpan"))) != null ? L : 1, S = (_ = Number(v.getAttribute("colSpan"))) != null ? _ : 1;
          if (O > 1 || S > 1) {
            const y = { rs: +O - 1, cs: +S - 1, r: i, c: d };
            t[i][d].mc = y;
            for (let E = 0; E < O; E++)
              for (let R = 0; R < S; R++)
                E === 0 && R === 0 || (t[i + E][d + R] = { mc: null });
          }
        }
        d++;
      }
...
`), s = o[0].split("	").length;
  for (let i = 0; i < o.length; i++)
    o[i].split("	").length < s || t.push(o[i].split("	"));
  for (let i = 0; i < t.length; i++)
    for (let u = 0; u < t[i].length; u++)
      t[i][u].length ? t[i][u] = {
        v: t[i][u] || "",
        m: t[i][u] || ""
      } : t[i][u] = null;
...
function u7(e, t) {
  ...
  for (let s = 0; s < e.length; s++)
    for (let i = 0; i < e[s].length; i++)
      if (e[s][i] && typeof e[s][i] == "object" && "mc" in e[s][i])
        if (e[s][i].mc) {
          const u = e[s][i].mc, d = u.r + n, v = d + u.rs, g = u.c + r, c = g + u.cs;
          o.push({ startRow: d, endRow: v, startColumn: g, endColumn: c }), delete e[s][i].mc;
        } else
          e[s][i] = null;
  return {
    data: e,
...
function d7(e) {
  ...
  return i.forEach((g) => {
    ...
    g.querySelectorAll("td").forEach((m) => {
      ...
      const _ = m.innerText;
      _.trim().length === 0 ? L.v = "" : L.v = _;
      let O = "";
      for (const R in o)
        m.classList.contains(R) && (O += o[R]);
      const S = dt(m, O);
      for (L9.isPlainObject(S) && (L.s = S); c < s && t[d][c] != null; )
        c++;
      if (c !== s) {
        if (t[d][c] == null) {
          t[d][c] = L;
          const R = (y = Number(m.getAttribute("rowSpan"))) != null ? y : 1, B = (E = Number(m.getAttribute("colSpan"))) != null ? E : 1;
          if (R > 1 || B > 1) {
            const w = { rs: +R - 1, cs: +B - 1, r: d, c };
            t[d][c].mc = w;
            for (let $ = 0; $ < R; $++)
              for (let T = 0; T < B; T++)
                $ === 0 && T === 0 || (t[d + $][c + T] = { mc: null });
          }
        }
        c++;
      }
...
`, "").split("}");
  for (let o = 0; o < r.length; o++) {
    if (!r[o]) continue;
    let s = r[o].split("{")[0].trim();
    s.includes(".") && (s = s.slice(1));
...
function xi(e) {
  const t = Math.round(e * _i);
  return t < a9 ? a9 : t > l9 ? l9 : t;
}
function Si(e) {
...
const h7 = y9((e) => {
  var O, S;
  const { layer: t, id: n, position: r } = e, o = k(A1), s = t1(null), i = t1(null), u = t1(`transform: rotate(${r == null ? void 0 : r.rotate}deg) translate(${r == null ? void 0 : r.startX}px, ${r == null ? void 0 : r.startY}px)`), d = t1((O = r == null ? void 0 : r.startY) != null ? O : 0), v = t1((S = r == null ? void 0 : r.startX) != null ? S : 0), g = typeof t.componentKey == "string" ? k(S1).get(t.componentKey) : t.componentKey, c = Q(() => ({
    data: t.data,
    ...t.props
  }), [t.data, t.props]), m = {
    width: `${r.width - 4}px`,
  ...
  u.current = `rotate(${r.rotate}deg)`, d.current = r.startY, v.current = r.startX;
  const L = o.getUnit(t.unitId), _ = Q(() => g ? /* @__PURE__ */ f(
    g,
    {
      ...c,
      unitId: t.unitId,
  ...
  return r ? /* @__PURE__ */ f(
    "div",
    {
      ...
      onPointerMove: (y) => {
        t.onPointerMove(y.nativeEvent);
      },
      onPointerDown: (y) => {
        t.onPointerDown(y.nativeEvent);
      },
      onPointerUp: (y) => {
        t.onPointerUp(y.nativeEvent);
      },
      onWheel: (y) => {
        t.onWheel(y.nativeEvent);
      },
      children: /* @__PURE__ */ f(
        "div",
        {
...
export {
  ...
  Qn as CanvasPopup,
  Xn as CanvasPopupService,
  h5 as CommonLabel,
  I1 as ComponentContainer,
  S1 as ComponentManager,
  co as ContextMenu,
  a1 as ContextMenuGroup,
  ...
  Mi as DEFAULT_BACKGROUND_COLOR_RGB,
  yi as DEFAULT_BACKGROUND_COLOR_RGBA,
  wi as DISABLE_AUTO_FOCUS_KEY,
  Ye as DesktopBeforeCloseService,
  Xe as DesktopConfirmService,
  qe as DesktopDialogService,
  Je as DesktopGalleryService,
  Qe as DesktopGlobalZoneService,
  Fe as DesktopLayoutService,
  lr as DesktopLocalFileService,
  cr as DesktopLocalStorageService,
  $5 as DesktopMenu,
  Ke as DesktopMessageService,
  e3 as DesktopNotificationService,
  ...
  t7 as FILE_SVG_XML_CLIPBOARD_MIME_TYPE,
  $o as FILE__BMP_CLIPBOARD_MIME_TYPE,
  Eo as FILE__JPEG_CLIPBOARD_MIME_TYPE,
  No as FILE__WEBP_CLIPBOARD_MIME_TYPE,
  w5 as FONT_FAMILY_COMPONENT,
  _5 as FONT_FAMILY_ITEM_COMPONENT,
  Ui as FONT_FAMILY_LIST,
  M5 as FONT_SIZE_COMPONENT,
  zi as FONT_SIZE_LIST,
  Gn as FloatDom,
  ...
  y5 as FontSize,
  tr as GlobalZone,
  v5 as HEADING_ITEM_COMPONENT,
  Wi as HEADING_LIST,
  Kt as HTML_CLIPBOARD_MIME_TYPE,
  C5 as HeadingItem,
  ir as IBeforeCloseService,
  rt as ICanvasPopupService,
  sr as IClipboardInterfaceService,
  at as IConfirmService,
  c3 as IContextMenuService,
  ct as IDialogService,
  ut as IGalleryService,
  st as IGlobalZoneService,
  U1 as ILayoutService,
  Pi as ILeftSidebarService,
  ar as ILocalFileService,
  B1 as IMenuManagerService,
  et as IMessageService,
  u3 as INotificationService,
  tt as IPlatformService,
  ye as IShortcutService,
  we as ISidebarService,
  We as IUIController,
  D1 as IUIPartsService,
  lt as IZenZoneService,
  q1 as KeyCode,
  H1 as MenuItemType,
  ke as MenuManagerPosition,
  je as MenuManagerService,
  L1 as MetaKeys,
  Lo as MobileContextMenu,
  o7 as MockMessageService,
  Qt as PLAIN_TEXT_CLIPBOARD_MIME_TYPE,
  jn as PasteCommand,
  Un as PlatformService,
  h7 as PrintFloatDomSingle,
  Qi as ProgressBar,
  ot as RectPopup,
  q5 as RedoShortcutItem,
  ao as Ribbon,
  fe as RibbonDataGroup,
  A3 as RibbonFormulasGroup,
  De as RibbonInsertGroup,
  Zn as RibbonOthersGroup,
  w1 as RibbonPosition,
  G1 as RibbonStartGroup,
  Te as RibbonViewGroup,
  ie as SharedController,
  e7 as SheetPasteShortKeyCommandName,
  se as ShortcutPanelController,
  G3 as ShortcutPanelService,
  ze as ShortcutService,
  nr as Sidebar,
  no as SingleCanvasPopup,
  or as SingleUnitUIController,
  ji as Slider,
  r7 as TestConfirmService,
  a3 as ThemeSwitcherService,
  l3 as ToggleShortcutPanelOperation,
  ro as ToolbarButton,
  Oe as ToolbarItem,
  $5 as UIMenu,
  B5 as UIMenuSchema,
  Yn as UIPartsService,
  _e as UI_PLUGIN_CONFIG_KEY,
  Li as UNIVER_UI_PLUGIN_NAME,
  Ki as UNI_DISABLE_CHANGING_FOCUS_KEY,
  X5 as UndoShortcutItem,
  F3 as UniverMobileUIPlugin,
  k3 as UniverUIPlugin,
  Pe as ZIndexManager,
  rr as ZenZone,
  ki as getHeaderFooterMenuHiddenObservable,
  Fi as getMenuHiddenObservable,
  d7 as handelExcelToJson,
  a7 as handelTableToJson,
  dr as handleDomToJson,
  c7 as handlePlainToJson,
  dt as handleStringToStyle,
  s7 as handleTableColgroup,
  u7 as handleTableMergeData,
  l7 as handleTableRowGroup,
  n7 as imageMimeTypeSet,
  a5 as mergeMenuConfigs,
  Ii as splitSpanText,
  So as supportClipboardAPI,
  Ji as t,
  O3 as textTrim,
  Gi as useClickOutSide,
  ...
  i7 as useSidebarClick,
  oo as useToolbarItemStatus,
  Yi as useUpdateEffect,
  qi as useVirtualList
};
