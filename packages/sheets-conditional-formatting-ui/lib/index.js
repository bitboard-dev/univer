...
import { CommandType as ge, ICommandService as te, IUniverInstanceService as Z, ColorKit as gn, BooleanNumber as se, LocaleService as re, UniverInstanceType as A, Tools as jt, get as cr, set as ur, createInterceptorKey as mn, InterceptorManager as dr, Inject as U, Disposable as le, Injector as me, Rectangle as Ce, generateRandomId as hr, ObjectMatrix as Ne, Range as ye, toDisposable as fn, InterceptorEffectEnum as vr, DependentOn as pn, IConfigService as Cn, Plugin as yn, merge as bn, registerDependencies as gr, touchDependencies as Vt } from "@univerjs/core";
...
import { Observable as Ee, debounceTime as Qt, merge as Pn } from "rxjs";
import { IRenderManagerService as Un } from "@univerjs/engine-render";
...
const On = {
  ...
  handler(t, e) {
    ...
    let y;
    if ([P.between, P.notBetween].includes(o)) {
      const f = s;
...
const ke = (t) => {
...
}, st = Y("univer-mt-5 univer-px-1 univer-py-2 univer-rounded", Fe), xe = (t, e) => ({ label: e.t(`sheet.cf.valueType.${t}`), value: t }), Pt = (t) => {
  var y;
  ...
  const { interceptorManager: e } = t, n = q(re), r = ((O = t.rule) == null ? void 0 : O.type) === L.colorScale ? t.rule : void 0, i = [xe($.num, n), xe($.percent, n), xe($.percentile, n), xe($.formula, n)], o = [xe($.min, n), ...i], s = [xe("none", n), ...i], d = [xe($.max, n), ...i], [a, h] = N(() => {
    ...
    const { minType: _, medianType: j, maxType: K, minValue: fe, medianValue: pe, maxValue: Le, minColor: Pe, medianColor: D, maxColor: B } = m, G = [];
    return G.push({ color: Pe, value: { type: _, value: fe } }), j !== "none" && G.push({ color: D, value: { type: j, value: pe } }), G.push({ color: B, value: { type: K, value: Le } }), { config: G.map((ee, ne) => ({ ...ee, index: ne })), type: L.colorScale };
  }, []);
...
}, Ue = (t, e) => ({ label: e.t(`sheet.cf.valueType.${t}`), value: t }), nn = (t) => {
  var f;
  ...
  const { interceptorManager: e } = t, n = q(re), r = ((O = t.rule) == null ? void 0 : O.type) === L.dataBar ? t.rule : void 0, [i, o] = N(() => {
    ...
    Ue($.percentile, n),
    Ue($.formula, n)
  ], u = [Ue($.min, n), ...l], v = [Ue($.max, n), ...l], [p, y] = N(() => {
    var _;
    const m = u[0].value;
  ...
  switch (X(() => {
    switch (e) {
      ...
      case F.number: {
        [P.equal, P.notEqual, P.greaterThan, P.greaterThanOrEqual, P.lessThan, P.lessThanOrEqual].includes(n) && r(d), [P.between, P.notBetween].includes(n) && r([f, x]);
        break;
      }
    }
  }, [e]), X(() => {
    ...
    case F.number: {
      if ([P.equal, P.notEqual, P.greaterThan, P.greaterThanOrEqual, P.lessThan, P.lessThanOrEqual].includes(n)) {
        const S = (C) => {
          a(C || 0), r(C || 0), l("");
        };
      ...
      if ([P.between, P.notBetween].includes(n)) {
        const S = (M) => {
          w(M || 0), r([M || 0, x]), R("");
        }, C = (M) => {
          T(M || 0), r([f, M || 0]), b("");
  ...
  const { interceptorManager: e, onChange: n } = t, r = q(re), i = ((T = t.rule) == null ? void 0 : T.type) === L.highlightCell ? t.rule : void 0, [o, s] = N(() => {
    ...
    var b, S, C, M, E, V, O, m, _, j, K, fe, pe, Le, Pe;
    switch (g.subType || o) {
      case F.text: {
  ...
  const { onChange: e, configList: n, errorMap: r = {} } = t, i = q(re), o = [{ label: i.t(`sheet.cf.symbol.${P.greaterThan}`), value: P.greaterThan }, { label: i.t(`sheet.cf.symbol.${P.greaterThanOrEqual}`), value: P.greaterThanOrEqual }], s = [
  ...
  const { onChange: e, interceptorManager: n } = t, r = q(re), i = ((w = t.rule) == null ? void 0 : w.type) === L.highlightCell ? t.rule : void 0, o = [{ label: r.t("sheet.cf.panel.isNotBottom"), value: "isNotBottom" }, { label: r.t("sheet.cf.panel.isBottom"), value: "isBottom" }, { label: r.t("sheet.cf.panel.greaterThanAverage"), value: "greaterThanAverage" }, { label: r.t("sheet.cf.panel.lessThanAverage"), value: "lessThanAverage" }], [s, d] = N(() => {
    ...
    if (R === "greaterThanAverage")
      return { type: L.highlightCell, subType: F.average, operator: P.greaterThan, style: g };
    if (R === "lessThanAverage")
      return { type: L.highlightCell, subType: F.average, operator: P.lessThan, style: g };
  };
  X(() => n.intercept(n.getInterceptPoints().submit, {
    handler() {
...
var Ui = Object.getOwnPropertyDescriptor, Oi = (t, e, n, r) => {
  for (var i = r > 1 ? void 0 : r ? Ui(e, n) : e, o = t.length - 1, s; o >= 0; o--)
    (s = t[o]) && (i = s(i) || i);
  return i;
}, $i = (t, e) => (n, r) => e(n, r, t);
...
const Ai = (t) => {
  ...
  const m = (D) => {
    ...
    we !== Re && o.executeCommand(Pr.id, { unitId: z, subUnitId: ee, start: { id: we, type: "self" }, end: { id: Re, type: G.y > B.y ? "after" : "before" } });
  }, K = () => {
    t.onCreate();
  }, fe = () => {
  ...
  }, [V]), Le = pe.map((D, B) => ({ i: D.cfId, x: 0, w: 12, y: B, h: 1, isResizable: !1 })), Pe = J(() => {
    const D = r.getCurrentUnitOfType(A.UNIVER_SHEET), B = D.getActiveSheet();
    return V.every((G) => {
      const z = G.ranges;
      return gt(d, D.getUnitId(), B.getSheetId(), z);
  ...
  return /* @__PURE__ */ k("div", { children: [
    /* @__PURE__ */ k("div", { className: "univer-flex univer-items-center univer-justify-between univer-gap-2 univer-text-sm", children: [
      ...
      /* @__PURE__ */ k("div", { className: "univer-flex univer-justify-end", children: [
        ...
        V.length && Pe ? /* @__PURE__ */ c(Xt, { title: s.t("sheet.cf.panel.clear"), placement: "bottom", children: /* @__PURE__ */ c(
          "a",
          {
            className: "univer-size-5 univer-cursor-pointer",
            onClick: fe,
  ...
  return /* @__PURE__ */ c("div", { className: "univer-flex univer-h-full univer-flex-col univer-justify-between univer-py-4", children: r ? /* @__PURE__ */ c(Pi, { onCancel: () => {
    i(!1), n(void 0);
...
const Mt = {
  ...
  handler: (t, e) => {
    ...
    switch (e.value) {
      ...
      case 9: {
        i.executeCommand(Ur.id, { ranges: o });
        break;
      }
      case 10: {
...
const hn = [
  ...
  const e = t.get(je), n = t.get(te), r = t.get(Z), i = t.get(Q), o = new Ee((a) => Pn(
    e.selectionMoveEnd$,
    e.selectionSet$,
    new Ee((h) => {
