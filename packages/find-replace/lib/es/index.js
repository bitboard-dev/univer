...
import { createIdentifier as at, Inject as N, Injector as ue, IContextService as J, Disposable as Q, DisposableCollection as ot, toDisposable as O, IUniverInstanceService as fe, ICommandService as U, CommandType as b, LocaleService as B, FOCUSING_SHEET as pe, EDITOR_ACTIVATED as _e, UniverInstanceType as ct, RxDisposable as lt, IConfigService as dt, Plugin as ht, merge as ut } from "@univerjs/core";
import { IConfirmService as ft, IMessageService as ge, useDependency as m, useObservable as P, useDebounceFn as pt, ILayoutService as me, KeyCode as C, MetaKeys as D, getMenuHiddenObservable as _t, MenuItemType as gt, RibbonStartGroup as mt, IMenuManagerService as St, IShortcutService as vt, IDialogService as Ct, ComponentManager as Mt } from "@univerjs/ui";
import { MessageType as $, Input as Se, Pager as Rt, FormLayout as R, Select as k, FormDualColumnLayout as re, Checkbox as ae, Button as j } from "@univerjs/design";
...
var q = /* @__PURE__ */ ((t) => (t.ROW = "row", t.COLUMN = "column", t))(q || {}), z = /* @__PURE__ */ ((t) => (t.VALUE = "value", t.FORMULA = "formula", t))(z || {}), Y = /* @__PURE__ */ ((t) => (t.SUBUNIT = "subunit", t.UNIT = "unit", t))(Y || {});
function te() {
  return {
    caseSensitive: !1,
    findBy: "value",
...
function $e(t, e, n, i, s) {
  return Me(t.tag, {
    ...
    ...Ot(t, n, s),
    ...i
  }, (At(t, n).children || []).map((r, a) => $e(r, `${e}-${t.tag}-${a}`, n, void 0, s)));
}
function Ot(t, e, n) {
  const i = { ...t.attrs };
...
const Ut = X(function(e, n) {
  ...
  const i = m(f), s = m(B), r = m(U), a = m(ge), l = P(i.currentMatch$, void 0, !0), d = P(i.replaceables$, void 0, !0), _ = P(i.state$, void 0, !0), {
    ...
    [i]
  ), { focus: ze } = Ae(i, n), Ye = u(() => {
    I === S ? i.moveToNextMatch() : (i.changeFindString(S), i.find());
  }, [I, S, i]), Ze = u(() => r.executeCommand(De.id), [r]), Je = u(async () => {
  ...
  return A(() => {
    ...
    /* @__PURE__ */ F("div", { className: "univer-mt-6 univer-flex univer-justify-between", children: [
      /* @__PURE__ */ c(j, { variant: "primary", onClick: Ye, disabled: Ve, children: s.t("find-replace.dialog.find") }),
      /* @__PURE__ */ F("span", { className: "univer-inline-flex univer-gap-2", children: [
        /* @__PURE__ */ c(j, { disabled: Ge, onClick: Ze, children: s.t("find-replace.dialog.replace") }),
